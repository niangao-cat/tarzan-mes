...
# 启动项目
cd /home/mes/hcms/
nohup java -jar -Dspring.profiles.active=rkpro1 \
-Dspring.cloud.config.enabled=false \
-Dspring.cloud.config.uri=http://mespro-1.raycus.com:8010 \
-Deureka.client.serviceUrl.defaultZone=http://mespro-1.raycus.com:8000/eureka \
