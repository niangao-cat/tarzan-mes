...
databaseChangeLog(logicalFilePath: 'script/db/qms_pqc_line_his.groovy') {
    changeSet(author: "chaonan.hu@hand-china.com", id: "2020-08-17-qms_pqc_line_his") {
        def weight = 1
        ...
        if(helper.dbType().isSupportSequence()){
            createSequence(sequenceName: 'qms_pqc_line_his_s', startValue:"1")
        }
        createTable(tableName: "qms_pqc_line_his", remarks: "巡检单行历史表") {
            column(name: "TENANT_ID", type: "bigint(20)",   defaultValue:"0",   remarks: "租户ID")  {constraints(nullable:"false")}  
            column(name: "PQC_HEADER_ID", type: "varchar(" + 100 * weight + ")",  remarks: "检验单头表ID")  {constraints(nullable:"false")}  
            column(name: "PQC_LINE_HIS_ID", type: "varchar(" + 100 * weight + ")",  remarks: "检验单行历史主键ID")  {constraints(primaryKey: true)} 
