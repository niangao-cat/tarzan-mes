...
databaseChangeLog(logicalFilePath: 'script/db/qms_pqc_header.groovy') {
    changeSet(author: "chaonan.hu@hand-china.com", id: "2020-08-17-qms_pqc_header") {
        def weight = 1
        ...
        if(helper.dbType().isSupportSequence()){
            createSequence(sequenceName: 'qms_pqc_header_s', startValue:"1")
        }
        createTable(tableName: "qms_pqc_header", remarks: "巡检单头表") {
            column(name: "TENANT_ID", type: "bigint(20)",   defaultValue:"0",   remarks: "租户ID")  {constraints(nullable:"false")}  
            column(name: "SITE_ID", type: "varchar(" + 100 * weight + ")",  remarks: "站点ID")   
            column(name: "PQC_HEADER_ID", type: "varchar(" + 100 * weight + ")",  remarks: "检验单头表主键")  {constraints(primaryKey: true)} 
        ...
        addUniqueConstraint(columnNames:"TENANT_ID,PQC_NUMBER",tableName:"qms_pqc_header",constraintName: "qms_pqc_header_u1")
    }
}