...
databaseChangeLog(logicalFilePath: 'script/db/qms_pqc_details_his.groovy') {
    changeSet(author: "chaonan.hu@hand-china.com", id: "2020-08-17-qms_pqc_details_his") {
        def weight = 1
        ...
        if(helper.dbType().isSupportSequence()){
            createSequence(sequenceName: 'qms_pqc_details_his_s', startValue:"1")
        }
        createTable(tableName: "qms_pqc_details_his", remarks: "巡检单明细历史表") {
            column(name: "TENANT_ID", type: "bigint(20)",   defaultValue:"0",   remarks: "租户ID")  {constraints(nullable:"false")}  
            column(name: "PQC_DETAILS_HIS_ID", type: "varchar(" + 100 * weight + ")",  remarks: "检验单明细历史表主键ID")  {constraints(primaryKey: true)} 
            column(name: "PQC_DETAILS_ID", type: "varchar(" + 100 * weight + ")",  remarks: "检验单明细主键ID")  {constraints(nullable:"false")}  
