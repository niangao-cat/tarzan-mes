...
databaseChangeLog(logicalFilePath: 'script/db/qms_iqc_line_his.groovy') {
    changeSet(author: "sanfeng.zhang@hand-china.com", id: "2020-08-06-qms_iqc_line_his") {
        def weight = 1
        ...
        if(helper.dbType().isSupportSequence()){
            createSequence(sequenceName: 'qms_iqc_line_his_s', startValue:"1")
        }
        createTable(tableName: "qms_iqc_line_his", remarks: "质检单行历史表") {
            column(name: "TENANT_ID", type: "bigint(20)",   defaultValue:"0",   remarks: "租户ID")  {constraints(nullable:"false")}  
            column(name: "IQC_LINE_HIS_ID", type: "varchar(" + 100 * weight + ")",  remarks: "检验单行历史表主键")  {constraints(primaryKey: true)} 
            column(name: "IQC_HEADER_ID", type: "varchar(" + 100 * weight + ")",  remarks: "检验单头表ID")  {constraints(nullable:"false")}  
            column(name: "IQC_LINE_ID", type: "varchar(" + 100 * weight + ")",  remarks: "检验单行主键ID")  {constraints(nullable:"false")}  
            ...
            column(name: "ACCEPTANCE_QUANTITY_LIMIT", type: "decimal(20,0)",  remarks: "AQL值")   
            ...
            column(name: "STANDARD_TEXT", type: "varchar(" + 100 * weight + ")",  remarks: "文本规格值")   
            column(name: "STANDARD_FROM", type: "decimal(20,0)",  remarks: "规格值从")  {constraints(nullable:"false")}  
            column(name: "STANDARD_TO", type: "decimal(20,0)",  remarks: "规格值至")  {constraints(nullable:"false")}  
            column(name: "STANDARD_UOM", type: "decimal(20,0)",  remarks: "规格单位")  {constraints(nullable:"false")}  
        ...
        addUniqueConstraint(columnNames:"TENANT_ID,IQC_LINE_HIS_ID,EVENT_ID",tableName:"qms_iqc_line_his",constraintName: "qms_iqc_line_his_u1")
    }
}