...
databaseChangeLog(logicalFilePath: 'script/db/mt_numrange.groovy') {
    changeSet(author: "jiangling.zheng@hand-china.com", id: "2020-06-30-mt_numrange") {
        def weight = 1
        ...
        if(helper.dbType().isSupportSequence()){
            createSequence(sequenceName: 'mt_numrange_s', startValue:"1")
        }
        createTable(tableName: "mt_numrange", remarks: "号码段定义表") {
            column(name: "TENANT_ID", type: "bigint(20)",   defaultValue:"0",   remarks: "租户ID")  {constraints(nullable:"false")}  
            column(name: "NUMRANGE_ID", type: "varchar(" + 100 * weight + ")",   defaultValue:"",   remarks: "号码段定义表主键")  {constraints(primaryKey: true)} 
        ...
        addUniqueConstraint(columnNames:"OBJECT_ID,NUMRANGE_GROUP,TENANT_ID",tableName:"mt_numrange",constraintName: "MT_NUMRANGE_U1")
    }
}