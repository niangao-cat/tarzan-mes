...
databaseChangeLog(logicalFilePath: 'script/db/mt_inv_onhand_hold.groovy') {
    changeSet(author: "liyuan.lv@hand-china.com", id: "2020-05-20-mt_inv_onhand_hold") {
        def weight = 1
        ...
        if(helper.dbType().isSupportSequence()){
            createSequence(sequenceName: 'mt_inv_onhand_hold_s', startValue:"1")
        }
        createTable(tableName: "mt_inv_onhand_hold", remarks: "库存保留量") {
            column(name: "TENANT_ID", type: "bigint(20)",   defaultValue:"0",   remarks: "租户ID")  {constraints(nullable:"false")}  
            column(name: "ONHAND_HOLD_ID", type: "varchar(" + 100 * weight + ")",   defaultValue:"",   remarks: "主键ID")  {constraints(primaryKey: true)} 
        ...
        addUniqueConstraint(columnNames:"TENANT_ID,SITE_ID,MATERIAL_ID,LOCATOR_ID,LOT_CODE,HOLD_TYPE,ORDER_TYPE,ORDER_ID,OWNER_TYPE,OWNER_ID",tableName:"mt_inv_onhand_hold",constraintName: "MT_INV_ONHAND_HOLD_U1")
    }
}