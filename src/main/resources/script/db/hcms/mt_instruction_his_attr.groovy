...
databaseChangeLog(logicalFilePath: 'script/db/mt_instruction_his_attr.groovy') {
    changeSet(author: "jiangling.zheng@hand-china.com", id: "2020-06-30-mt_instruction_his_attr") {
        def weight = 1
        ...
        if(helper.dbType().isSupportSequence()){
            createSequence(sequenceName: 'mt_instruction_his_attr_s', startValue:"1")
        }
        createTable(tableName: "mt_instruction_his_attr", remarks: "仓储物流指令内容历史扩展表") {
            ...
            column(name: "INSTRUCTION_HIS_ID", type: "varchar(" + 100 * weight + ")",   defaultValue:"",   remarks: "主表的历史表主键ID")  {constraints(nullable:"false")}  
        ...
        addUniqueConstraint(columnNames:"TENANT_ID,INSTRUCTION_HIS_ID,ATTR_NAME,EVENT_ID,LANG",tableName:"mt_instruction_his_attr",constraintName: "MT_INSTRUCTION_ACTUAL_HIS_ATTR_U1")
    }
}