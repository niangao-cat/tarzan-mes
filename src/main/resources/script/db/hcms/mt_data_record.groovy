...
databaseChangeLog(logicalFilePath: 'script/db/mt_data_record.groovy') {
    changeSet(author: "jiangling.zheng@hand-china.com", id: "2020-06-30-mt_data_record") {
        def weight = 1
        ...
        if(helper.dbType().isSupportSequence()){
            createSequence(sequenceName: 'mt_data_record_s', startValue:"1")
        }
        createTable(tableName: "mt_data_record", remarks: "数据收集实绩") {
            column(name: "TENANT_ID", type: "bigint(20)",   defaultValue:"0",   remarks: "租户ID")  {constraints(nullable:"false")}  
            column(name: "DATA_RECORD_ID", type: "varchar(" + 100 * weight + ")",   defaultValue:"",   remarks: "主键")  {constraints(nullable:"false")}  
        ...
        addUniqueConstraint(columnNames:"DATA_RECORD_ID,TENANT_ID",tableName:"mt_data_record",constraintName: "mt_data_record_pk")
    }
}