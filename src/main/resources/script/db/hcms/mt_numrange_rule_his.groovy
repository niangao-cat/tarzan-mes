...
databaseChangeLog(logicalFilePath: 'script/db/mt_numrange_rule_his.groovy') {
    changeSet(author: "jiangling.zheng@hand-china.com", id: "2020-06-30-mt_numrange_rule_his") {
        def weight = 1
        ...
        if(helper.dbType().isSupportSequence()){
            createSequence(sequenceName: 'mt_numrange_rule_his_s', startValue:"1")
        }
        createTable(tableName: "mt_numrange_rule_his", remarks: "号码段定义组合规则历史表") {
            column(name: "TENANT_ID", type: "bigint(20)",   defaultValue:"0",   remarks: "租户ID")  {constraints(nullable:"false")}  
            column(name: "NUMRANGE_RULE_HIS_ID", type: "varchar(" + 100 * weight + ")",   defaultValue:"",   remarks: "号码段定义组合规则历史表主键")  {constraints(primaryKey: true)} 
            column(name: "NUMRANGE_RULE_ID", type: "varchar(" + 100 * weight + ")",   defaultValue:"",   remarks: "号码段定义组合规则表主键")  {constraints(nullable:"false")}  
        ...
        addUniqueConstraint(columnNames:"NUMRANGE_RULE_ID,EVENT_ID,TENANT_ID",tableName:"mt_numrange_rule_his",constraintName: "MT_NUMRANGE_RULE_HIS_U1")
    }
}