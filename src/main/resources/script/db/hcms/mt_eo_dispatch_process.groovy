...
databaseChangeLog(logicalFilePath: 'script/db/mt_eo_dispatch_process.groovy') {
    changeSet(author: "jiangling.zheng@hand-china.com", id: "2020-06-30-mt_eo_dispatch_process") {
        def weight = 1
        ...
        if(helper.dbType().isSupportSequence()){
            createSequence(sequenceName: 'mt_eo_dispatch_process_s', startValue:"1")
        }
        createTable(tableName: "mt_eo_dispatch_process", remarks: "调度过程处理表") {
            column(name: "TENANT_ID", type: "bigint(20)",   defaultValue:"0",   remarks: "租户ID")  {constraints(nullable:"false")}  
            column(name: "EO_DISPATCH_PROCESS_ID", type: "varchar(" + 100 * weight + ")",   defaultValue:"",   remarks: "主键ID，标识唯一一条记录")  {constraints(primaryKey: true)} 
