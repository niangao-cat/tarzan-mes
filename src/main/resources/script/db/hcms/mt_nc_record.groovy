...
databaseChangeLog(logicalFilePath: 'script/db/mt_nc_record.groovy') {
    changeSet(author: "jiangling.zheng@hand-china.com", id: "2020-06-30-mt_nc_record") {
        def weight = 1
        ...
        if(helper.dbType().isSupportSequence()){
            createSequence(sequenceName: 'mt_nc_record_s', startValue:"1")
        }
        createTable(tableName: "mt_nc_record", remarks: "不良代码记录") {
            column(name: "TENANT_ID", type: "bigint(20)",   defaultValue:"0",   remarks: "租户ID")  {constraints(nullable:"false")}  
            column(name: "NC_RECORD_ID", type: "varchar(" + 100 * weight + ")",   defaultValue:"",   remarks: "唯一标识，表ID，主键，供其他表做外键")  {constraints(primaryKey: true)} 
            ...
            column(name: "CLOSURE_REQUIRED_FLAG", type: "varchar(" + 1 * weight + ")",   defaultValue:"",   remarks: "是否必须被关闭")  {constraints(nullable:"false")}  
            column(name: "CLOSED_DATE_TIME", type: "datetime",  remarks: "事故关闭日期")   
            column(name: "CLOSED_USER_ID", type: "bigint(20)",  remarks: "事故关闭人")   
        ...
        addUniqueConstraint(columnNames:"EO_ID,NC_INCIDENT_ID,NC_CODE_ID,TENANT_ID",tableName:"mt_nc_record",constraintName: "MT_NC_RECORD_U1")
    }
}