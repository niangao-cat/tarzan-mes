...
databaseChangeLog(logicalFilePath: 'script/db/mt_router_step.groovy') {
    changeSet(author: "jiangling.zheng@hand-china.com", id: "2020-06-30-mt_router_step") {
        def weight = 1
        ...
        if(helper.dbType().isSupportSequence()){
            createSequence(sequenceName: 'mt_router_step_s', startValue:"1")
        }
        createTable(tableName: "mt_router_step", remarks: "工艺路线步骤") {
            column(name: "TENANT_ID", type: "bigint(20)",   defaultValue:"0",   remarks: "租户ID")  {constraints(nullable:"false")}  
            column(name: "ROUTER_STEP_ID", type: "varchar(" + 100 * weight + ")",   defaultValue:"",   remarks: "工艺路线步骤唯一标识")  {constraints(primaryKey: true)} 
            ...
            column(name: "ROUTER_STEP_TYPE", type: "varchar(" + 255 * weight + ")",   defaultValue:"",   remarks: "步骤类型：TYPE_GROUP:ROUTER_STEP_TYPE 1.【OPERATION】工艺 2.【GROUP】步骤组 3.【ROUTER】嵌套工艺路线")  {constraints(nullable:"false")}  
   ...
   createIndex(tableName: "mt_router_step", indexName: "MT_ROUTER_STEP_N1") {
            column(name: "ENTRY_STEP_FLAG")
        }

        addUniqueConstraint(columnNames:"ROUTER_ID,STEP_NAME,TENANT_ID",tableName:"mt_router_step",constraintName: "MT_ROUTER_STEP_U1")
    }
}