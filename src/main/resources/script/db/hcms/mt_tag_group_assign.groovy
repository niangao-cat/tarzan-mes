...
databaseChangeLog(logicalFilePath: 'script/db/mt_tag_group_assign.groovy') {
    changeSet(author: "jiangling.zheng@hand-china.com", id: "2020-06-30-mt_tag_group_assign") {
        def weight = 1
        ...
        if(helper.dbType().isSupportSequence()){
            createSequence(sequenceName: 'mt_tag_group_assign_s', startValue:"1")
        }
        createTable(tableName: "mt_tag_group_assign", remarks: "数据收集项分配收集组表") {
            column(name: "TENANT_ID", type: "bigint(20)",   defaultValue:"0",   remarks: "租户ID")  {constraints(nullable:"false")}  
            column(name: "TAG_GROUP_ASSIGN_ID", type: "varchar(" + 100 * weight + ")",   defaultValue:"",   remarks: "数据收集项分配收集组ID")  {constraints(primaryKey: true)} 
        ...
        addUniqueConstraint(columnNames:"TAG_GROUP_ID,TAG_ID,TENANT_ID",tableName:"mt_tag_group_assign",constraintName: "mt_tag_group_assign_u1")
        addUniqueConstraint(columnNames:"TAG_GROUP_ID,SERIAL_NUMBER,TENANT_ID",tableName:"mt_tag_group_assign",constraintName: "mt_tag_group_assign_u2")
    }
}