...
databaseChangeLog(logicalFilePath: 'script/db/mt_pfep_distribution.groovy') {
    changeSet(author: "jiangling.zheng@hand-china.com", id: "2020-06-30-mt_pfep_distribution") {
        def weight = 1
        ...
        if(helper.dbType().isSupportSequence()){
            createSequence(sequenceName: 'mt_pfep_distribution_s', startValue:"1")
        }
        createTable(tableName: "mt_pfep_distribution", remarks: "物料配送属性（一个WKC的物料类别和物料不能有从属关系）") {
            column(name: "TENANT_ID", type: "bigint(20)",   defaultValue:"0",   remarks: "租户ID")  {constraints(nullable:"false")}  
            column(name: "PFEP_DISTRIBUTION_ID", type: "varchar(" + 100 * weight + ")",   defaultValue:"",   remarks: "主键，唯一标识")  {constraints(primaryKey: true)} 
        ...
        addUniqueConstraint(columnNames:"MATERIAL_SITE_ID,ORGANIZATION_ID,ORGANIZATION_TYPE,LOCATOR_ID,TENANT_ID",tableName:"mt_pfep_distribution",constraintName: "MT_PFEP_DISTRIBUTION_U1")
    }
}