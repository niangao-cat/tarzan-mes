...
databaseChangeLog(logicalFilePath: 'script/db/mt_instruction_actual_his.groovy') {
    changeSet(author: "jiangling.zheng@hand-china.com", id: "2020-06-30-mt_instruction_actual_his") {
        def weight = 1
        ...
        if(helper.dbType().isSupportSequence()){
            createSequence(sequenceName: 'mt_instruction_actual_his_s', startValue:"1")
        }
        createTable(tableName: "mt_instruction_actual_his", remarks: "指令实绩汇总历史表") {
            column(name: "TENANT_ID", type: "bigint(20)",   defaultValue:"0",   remarks: "租户ID")  {constraints(nullable:"false")}  
            column(name: "ACTUAL_HIS_ID", type: "varchar(" + 100 * weight + ")",   defaultValue:"",   remarks: "指令实绩汇总历史id")  {constraints(primaryKey: true)} 
            column(name: "EVENT_ID", type: "varchar(" + 100 * weight + ")",   defaultValue:"",   remarks: "事件ID")  {constraints(nullable:"false")}  
            column(name: "ACTUAL_ID", type: "varchar(" + 100 * weight + ")",   defaultValue:"",   remarks: "指令实绩汇总id")  {constraints(nullable:"false")}  
        ...
        addUniqueConstraint(columnNames:"ACTUAL_ID,EVENT_ID,TENANT_ID",tableName:"mt_instruction_actual_his",constraintName: "MT_INSTRUCTION_ACTUAL_HIS_U1")
    }
}