...
databaseChangeLog(logicalFilePath: 'script/db/mt_eo_step_actual.groovy') {
    changeSet(author: "jiangling.zheng@hand-china.com", id: "2020-06-30-mt_eo_step_actual") {
        def weight = 1
        ...
        if(helper.dbType().isSupportSequence()){
            createSequence(sequenceName: 'mt_eo_step_actual_s', startValue:"1")
        }
        createTable(tableName: "mt_eo_step_actual", remarks: "执行作业-工艺路线步骤执行实绩") {
            column(name: "TENANT_ID", type: "bigint(20)",   defaultValue:"0",   remarks: "租户ID")  {constraints(nullable:"false")}  
            column(name: "EO_STEP_ACTUAL_ID", type: "varchar(" + 100 * weight + ")",   defaultValue:"",   remarks: "主键ID，标识唯一一条记录")  {constraints(primaryKey: true)} 
        ...
        addUniqueConstraint(columnNames:"EO_ROUTER_ACTUAL_ID,ROUTER_STEP_ID,TENANT_ID",tableName:"mt_eo_step_actual",constraintName: "MT_EO_STEP_ACTUAL_U1")
    }
}