...
databaseChangeLog(logicalFilePath: 'script/db/mt_work_order_his.groovy') {
    changeSet(author: "jiangling.zheng@hand-china.com", id: "2020-06-30-mt_work_order_his") {
        def weight = 1
        ...
        if(helper.dbType().isSupportSequence()){
            createSequence(sequenceName: 'mt_work_order_his_s', startValue:"1")
        }
        createTable(tableName: "mt_work_order_his", remarks: "生产指令历史") {
            column(name: "TENANT_ID", type: "bigint(20)",   defaultValue:"0",   remarks: "租户ID")  {constraints(nullable:"false")}  
            column(name: "WORK_ORDER_HIS_ID", type: "varchar(" + 100 * weight + ")",   defaultValue:"",   remarks: "主键ID，标识唯一一条数据")  {constraints(primaryKey: true)} 
            ...
            column(name: "TRX_QTY", type: "decimal(36,6)",  remarks: "影响数量")   
        ...
        addUniqueConstraint(columnNames:"WORK_ORDER_ID,EVENT_ID,TENANT_ID",tableName:"mt_work_order_his",constraintName: "MT_WORK_ORDER_HIS_U1")
    }
}