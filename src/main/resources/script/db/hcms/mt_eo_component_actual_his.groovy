...
databaseChangeLog(logicalFilePath: 'script/db/mt_eo_component_actual_his.groovy') {
    changeSet(author: "jiangling.zheng@hand-china.com", id: "2020-06-30-mt_eo_component_actual_his") {
        def weight = 1
        ...
        if(helper.dbType().isSupportSequence()){
            createSequence(sequenceName: 'mt_eo_component_actual_his_s', startValue:"1")
        }
        createTable(tableName: "mt_eo_component_actual_his", remarks: "执行作业组件装配实绩历史，记录执行作业物料和组件实际装配情况变更历史") {
            column(name: "TENANT_ID", type: "bigint(20)",   defaultValue:"0",   remarks: "租户ID")  {constraints(nullable:"false")}  
            column(name: "EO_COMPONENT_ACTUAL_HIS_ID", type: "varchar(" + 100 * weight + ")",   defaultValue:"",   remarks: "执行作业组件实绩历史ID")  {constraints(primaryKey: true)} 
            column(name: "EO_COMPONENT_ACTUAL_ID", type: "varchar(" + 100 * weight + ")",   defaultValue:"",   remarks: "执行作业组件实绩ID")  {constraints(nullable:"false")}  
            ...
            column(name: "ASSEMBLE_QTY", type: "decimal(20,6)",  remarks: "实际装配数量，六位小数")  {constraints(nullable:"false")}  
            column(name: "SCRAPPED_QTY", type: "decimal(20,6)",  remarks: "实际报废数量，六位小数")  {constraints(nullable:"false")}  
            ...
            column(name: "BOM_ID", type: "varchar(" + 100 * weight + ")",   defaultValue:"",   remarks: "装配时引用的装配清单")  {constraints(nullable:"false")}  
        ...
        addUniqueConstraint(columnNames:"EO_COMPONENT_ACTUAL_ID,EVENT_ID,TENANT_ID",tableName:"mt_eo_component_actual_his",constraintName: "MT_EO_COMPONENT_ACTUAL_HIS_U1")
    }
}