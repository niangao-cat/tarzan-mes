...
databaseChangeLog(logicalFilePath: 'script/db/mt_data_record_his_attr.groovy') {
    changeSet(author: "jiangling.zheng@hand-china.com", id: "2020-06-30-mt_data_record_his_attr") {
        def weight = 1
        ...
        if(helper.dbType().isSupportSequence()){
            createSequence(sequenceName: 'mt_data_record_his_attr_s', startValue:"1")
        }
        createTable(tableName: "mt_data_record_his_attr", remarks: "数据收集实绩历史扩展表") {
            ...
            column(name: "DATA_RECORD_HIS_ID", type: "varchar(" + 100 * weight + ")",   defaultValue:"",   remarks: "主表的历史表主键ID")  {constraints(nullable:"false")}  
        ...
        addUniqueConstraint(columnNames:"TENANT_ID,DATA_RECORD_HIS_ID,ATTR_NAME,EVENT_ID,LANG",tableName:"mt_data_record_his_attr",constraintName: "MT_DATA_RECORD_HIS_ATTR_U1")
    }
}