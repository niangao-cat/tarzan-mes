...
databaseChangeLog(logicalFilePath: 'script/db/mt_instruction_doc_his.groovy') {
    changeSet(author: "jiangling.zheng@hand-china.com", id: "2020-06-30-mt_instruction_doc_his") {
        def weight = 1
        ...
        if(helper.dbType().isSupportSequence()){
            createSequence(sequenceName: 'mt_instruction_doc_his_s', startValue:"1")
        }
        createTable(tableName: "mt_instruction_doc_his", remarks: "指令单据头历史表") {
            column(name: "TENANT_ID", type: "bigint(20)",   defaultValue:"0",   remarks: "租户ID")  {constraints(nullable:"false")}  
            column(name: "INSTRUCTION_DOC_HIS_ID", type: "varchar(" + 100 * weight + ")",   defaultValue:"",   remarks: "主键ID，表示唯一一条记录")  {constraints(primaryKey: true)} 
            column(name: "EVENT_ID", type: "varchar(" + 100 * weight + ")",   defaultValue:"",   remarks: "事件ID")  {constraints(nullable:"false")}  
            column(name: "INSTRUCTION_DOC_ID", type: "varchar(" + 100 * weight + ")",   defaultValue:"",   remarks: "主键ID，表示唯一一条记录")  {constraints(nullable:"false")}  
        ...
        addUniqueConstraint(columnNames:"INSTRUCTION_DOC_ID,EVENT_ID,TENANT_ID",tableName:"mt_instruction_doc_his",constraintName: "MT_INSTRUCTION_DOC_HIS_U1")
    }
}