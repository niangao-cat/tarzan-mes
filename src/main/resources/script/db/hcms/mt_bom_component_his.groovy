...
databaseChangeLog(logicalFilePath: 'script/db/mt_bom_component_his.groovy') {
    changeSet(author: "jiangling.zheng@hand-china.com", id: "2020-06-30-mt_bom_component_his") {
        def weight = 1
        ...
        if(helper.dbType().isSupportSequence()){
            createSequence(sequenceName: 'mt_bom_component_his_s', startValue:"1")
        }
        createTable(tableName: "mt_bom_component_his", remarks: "装配清单行历史表") {
            column(name: "TENANT_ID", type: "bigint(20)",   defaultValue:"0",   remarks: "租户ID")  {constraints(nullable:"false")}  
            column(name: "BOM_COMPONENT_HIS_ID", type: "varchar(" + 100 * weight + ")",   defaultValue:"",   remarks: "物料清单行历史ID")  {constraints(primaryKey: true)} 
            column(name: "BOM_COMPONENT_ID", type: "varchar(" + 100 * weight + ")",   defaultValue:"",   remarks: "物料清单行ID")  {constraints(nullable:"false")}  
        ...
        addUniqueConstraint(columnNames:"BOM_COMPONENT_ID,EVENT_ID,TENANT_ID",tableName:"mt_bom_component_his",constraintName: "MT_BOM_COMPONENT_HIS_U1")
    }
}