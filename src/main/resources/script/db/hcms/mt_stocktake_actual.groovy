...
databaseChangeLog(logicalFilePath: 'script/db/mt_stocktake_actual.groovy') {
    changeSet(author: "jiangling.zheng@hand-china.com", id: "2020-06-30-mt_stocktake_actual") {
        def weight = 1
        ...
        if(helper.dbType().isSupportSequence()){
            createSequence(sequenceName: 'mt_stocktake_actual_s', startValue:"1")
        }
        createTable(tableName: "mt_stocktake_actual", remarks: "盘点实绩表") {
            column(name: "TENANT_ID", type: "bigint(20)",   defaultValue:"0",   remarks: "租户ID")  {constraints(nullable:"false")}  
            column(name: "STOCKTAKE_ACTUAL_ID", type: "varchar(" + 100 * weight + ")",   defaultValue:"",   remarks: "盘点指令实绩ID")  {constraints(primaryKey: true)} 
        ...
        addUniqueConstraint(columnNames:"STOCKTAKE_ID,MATERIAL_LOT_ID,TENANT_ID",tableName:"mt_stocktake_actual",constraintName: "MT_STOCKTAKE_ACTUAL_U1")
    }
}