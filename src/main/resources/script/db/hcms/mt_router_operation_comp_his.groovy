...
databaseChangeLog(logicalFilePath: 'script/db/mt_router_operation_comp_his.groovy') {
    changeSet(author: "jiangling.zheng@hand-china.com", id: "2020-06-30-mt_router_operation_comp_his") {
        def weight = 1
        ...
        if(helper.dbType().isSupportSequence()){
            createSequence(sequenceName: 'mt_router_operation_comp_his_s', startValue:"1")
        }
        createTable(tableName: "mt_router_operation_comp_his", remarks: "工艺路线步骤对应工序组件历史") {
        ...
        addUniqueConstraint(columnNames:"ROUTER_OPERATION_COMPONENT_ID,EVENT_ID,TENANT_ID",tableName:"mt_router_operation_comp_his",constraintName: "MT_ROUTER_OPER_COMP_HIS_U1")
    }
}