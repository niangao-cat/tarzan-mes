...
databaseChangeLog(logicalFilePath: 'script/db/mt_tag.groovy') {
    changeSet(author: "jiangling.zheng@hand-china.com", id: "2020-06-30-mt_tag") {
        def weight = 1
        ...
        if(helper.dbType().isSupportSequence()){
            createSequence(sequenceName: 'mt_tag_s', startValue:"1")
        }
        createTable(tableName: "mt_tag", remarks: "数据收集项表") {
            column(name: "TENANT_ID", type: "bigint(20)",   defaultValue:"0",   remarks: "租户ID")  {constraints(nullable:"false")}  
            column(name: "TAG_ID", type: "varchar(" + 100 * weight + ")",   defaultValue:"",   remarks: "数据项ID")  {constraints(primaryKey: true)} 
            ...
            column(name: "LATEST_HIS_ID", type: "varchar(" + 100 * weight + ")",  remarks: "最新一次新增历史表的主键")   
        ...
        addUniqueConstraint(columnNames:"TAG_CODE,TENANT_ID",tableName:"mt_tag",constraintName: "MT_TAG_U1")
    }
}