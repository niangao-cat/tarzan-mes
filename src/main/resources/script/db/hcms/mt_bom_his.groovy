...
databaseChangeLog(logicalFilePath: 'script/db/mt_bom_his.groovy') {
    changeSet(author: "jiangling.zheng@hand-china.com", id: "2020-06-30-mt_bom_his") {
        def weight = 1
        ...
        if(helper.dbType().isSupportSequence()){
            createSequence(sequenceName: 'mt_bom_his_s', startValue:"1")
        }
        createTable(tableName: "mt_bom_his", remarks: "装配清单头历史") {
            column(name: "TENANT_ID", type: "bigint(20)",   defaultValue:"0",   remarks: "租户ID")  {constraints(nullable:"false")}  
            column(name: "BOM_HIS_ID", type: "varchar(" + 100 * weight + ")",   defaultValue:"",   remarks: "装配清单头历史ID")  {constraints(primaryKey: true)} 
            ...
            column(name: "AUTO_REVISION_FLAG", type: "varchar(" + 1 * weight + ")",   defaultValue:"",   remarks: "自动升版本标识")   
        ...
        addUniqueConstraint(columnNames:"BOM_ID,EVENT_ID,TENANT_ID",tableName:"mt_bom_his",constraintName: "MT_BOM_HIS_U1")
    }
}