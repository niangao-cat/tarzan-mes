...
databaseChangeLog(logicalFilePath: 'script/db/hme_logistics_info.groovy') {
    changeSet(author: "chaonan.hu@hand-china.com", id: "2020-08-31-hme_logistics_info") {
        def weight = 1
        ...
        if(helper.dbType().isSupportSequence()){
            createSequence(sequenceName: 'hme_logistics_info_s', startValue:"1")
        }
        createTable(tableName: "hme_logistics_info", remarks: "物流信息表") {
            column(name: "tenant_id", type: "bigint(20)",  remarks: "租户ID")  {constraints(nullable:"false")}  
            column(name: "logistics_info_id", type: "varchar(" + 100 * weight + ")",  remarks: "物流信息表主键")  {constraints(primaryKey: true)} 
        ...
        addUniqueConstraint(columnNames:"tenant_id,logistics_number",tableName:"hme_logistics_info",constraintName: "hme_logistics_info_u1")
    }
}