...
databaseChangeLog(logicalFilePath: 'script/db/hme_operation_time_material_his.groovy') {
    changeSet(author: "chaonan.hu@hand-china.com", id: "2020-08-11-hme_operation_time_material_his") {
        def weight = 1
        ...
        if(helper.dbType().isSupportSequence()){
            createSequence(sequenceName: 'hme_operation_time_material_his_s', startValue:"1")
        }
        createTable(tableName: "hme_operation_time_material_his", remarks: "时效要求关联物料历史表") {
            column(name: "tenant_id", type: "bigint(20)",  remarks: "租户ID")  {constraints(nullable:"false")}  
            column(name: "operation_time_material_his_id", type: "varchar(" + 100 * weight + ")",  remarks: "主键")  {constraints(primaryKey: true)} 
            column(name: "operation_time_material_id", type: "varchar(" + 100 * weight + ")",  remarks: "")  {constraints(nullable:"false")}  
