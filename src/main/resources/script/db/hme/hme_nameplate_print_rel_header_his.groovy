...
databaseChangeLog(logicalFilePath: 'script/db/hme_nameplate_print_rel_header_his.groovy') {
changeSet(author: "wengang.qiang@hand-china.com", id: "2021-10-19-hme_nameplate_print_rel_header_his") {
    def weight = 1
    ...
    if(helper.dbType().isSupportSequence()){
        createSequence(sequenceName: 'hme_nameplate_print_rel_header_his_s', startValue:"1")
    }
    createTable(tableName: "hme_nameplate_print_rel_header_his", remarks: "铭牌打印内部识别码对应关系头历史表") {
        column(name: "tenant_id", type: "bigint",   defaultValue:"0",   remarks: "租户id")  {constraints(nullable:"false")}  
        column(name: "nameplate_header_his_id", type: "varchar(" + 100 * weight + ")",  remarks: "主键ID")  {constraints(primaryKey: true)} 
        column(name: "nameplate_header_id", type: "varchar(" + 100 * weight + ")",  remarks: "头表主键ID")  {constraints(nullable:"false")}  
        column(name: "nameplate_order", type: "varchar(" + 3 * weight + ")",  remarks: "序列")   
        ...
        createIndex(tableName: "hme_nameplate_print_rel_header_his", indexName: "hme_nameplate_print_rel_header_his_n1") {
                column(name: "nameplate_header_id")
