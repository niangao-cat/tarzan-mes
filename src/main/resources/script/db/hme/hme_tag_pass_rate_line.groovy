...
databaseChangeLog(logicalFilePath: 'script/db/hme_tag_pass_rate_line.groovy') {
changeSet(author: "wengang.qiang@hand-china.com", id: "2021-09-15-hme_tag_pass_rate_line") {
    def weight = 1
    ...
    if(helper.dbType().isSupportSequence()){
        createSequence(sequenceName: 'hme_tag_pass_rate_line_s', startValue:"1")
    }
    createTable(tableName: "hme_tag_pass_rate_line", remarks: "偏振度和发散角良率维护行表") {
        column(name: "tenant_id", type: "bigint",   defaultValue:"0",   remarks: "租户id")  {constraints(nullable:"false")}  
        column(name: "header_id", type: "varchar(" + 100 * weight + ")",  remarks: "头表ID")  {constraints(nullable:"false")}  
        ...
        column(name: "ATTRIBUTE15", type: "varchar(" + 150 * weight + ")",  remarks: "")   
                ...
                addUniqueConstraint(columnNames:"header_id,priority,tenant_id",tableName:"hme_tag_pass_rate_line",constraintName: "hme_tag_pass_rate_line_u1")
        }
}