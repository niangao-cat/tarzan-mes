...
databaseChangeLog(logicalFilePath: 'script/db/hme_operation_time_his.groovy') {
    changeSet(author: "chaonan.hu@hand-china.com", id: "2020-08-11-hme_operation_time_his") {
        def weight = 1
        ...
        if(helper.dbType().isSupportSequence()){
            createSequence(sequenceName: 'hme_operation_time_his_s', startValue:"1")
        }
        createTable(tableName: "hme_operation_time_his", remarks: "工艺时效要求历史表") {
            column(name: "tenant_id", type: "bigint(20)",  remarks: "租户Id")  {constraints(nullable:"false")}  
            column(name: "operation_time_his_id", type: "varchar(" + 100 * weight + ")",  remarks: "主键")  {constraints(primaryKey: true)} 
            column(name: "operation_time_id", type: "varchar(" + 100 * weight + ")",  remarks: "")  {constraints(nullable:"false")}  
