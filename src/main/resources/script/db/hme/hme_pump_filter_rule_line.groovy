...
databaseChangeLog(logicalFilePath: 'script/db/hme_pump_filter_rule_line.groovy') {
    changeSet(author: "sanfeng.zhang@hand-china.com", id: "2021-08-20-hme_pump_filter_rule_line") {
        def weight = 1
        ...
        if(helper.dbType().isSupportSequence()){
            createSequence(sequenceName: 'hme_pump_filter_rule_line_s', startValue:"1")
        }
        createTable(tableName: "hme_pump_filter_rule_line", remarks: "泵浦源筛选规则行表") {
            column(name: "tenant_id", type: "bigint(20)",   defaultValue:"0",   remarks: "租户id")  {constraints(nullable:"false")}  
            column(name: "rule_line_id", type: "varchar(" + 100 * weight + ")",  remarks: "行表主键")  {constraints(primaryKey: true)} 
        ...
        addUniqueConstraint(columnNames:"rule_head_id,parameter_code,tenant_id",tableName:"hme_pump_filter_rule_line",constraintName: "hme_pump_filter_rule_line_u1")
    }
}