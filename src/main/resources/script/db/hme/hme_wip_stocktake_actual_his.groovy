...
databaseChangeLog(logicalFilePath: 'script/db/hme_wip_stocktake_actual_his.groovy') {
    changeSet(author: "chaonan.hu@hand-china.com", id: "2021-03-03-hme_wip_stocktake_actual_his") {
        def weight = 1
        ...
        if(helper.dbType().isSupportSequence()){
            createSequence(sequenceName: 'hme_wip_stocktake_actual_his_s', startValue:"1")
        }
        createTable(tableName: "hme_wip_stocktake_actual_his", remarks: "在制盘点实际历史") {
            column(name: "stocktake_actual_his_id", type: "varchar(" + 100 * weight + ")",  remarks: "主键")  {constraints(primaryKey: true)} 
            column(name: "stocktake_actual_id", type: "varchar(" + 100 * weight + ")",  remarks: "盘点实际ID")  {constraints(nullable:"false")}  
   ...
   createIndex(tableName: "hme_wip_stocktake_actual_his", indexName: "hme_wip_stocktake_actual_his_n1") {
            column(name: "stocktake_actual_id")
