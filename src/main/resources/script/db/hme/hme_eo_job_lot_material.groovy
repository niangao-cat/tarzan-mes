...
databaseChangeLog(logicalFilePath: 'script/db/hme_eo_job_lot_material.groovy') {
    changeSet(author: "jiangling.zheng@hand-china.com", id: "2020-06-30-hme_eo_job_lot_material") {
        def weight = 1
        ...
        if(helper.dbType().isSupportSequence()){
            createSequence(sequenceName: 'hme_eo_job_lot_material_s', startValue:"1")
        }
        createTable(tableName: "hme_eo_job_lot_material", remarks: "工序作业-工位与批次物料关系表") {
            ...
            column(name: "sn_material_id", type: "varchar(" + 100 * weight + ")",  remarks: "产品ID")   
            ...
            column(name: "cost_qty", type: "decimal(36,6)",  remarks: "条码消耗量")   
   ...
   createIndex(tableName: "hme_eo_job_lot_material", indexName: "hme_eo_job_lot_material_n1") {
