...
databaseChangeLog(logicalFilePath: 'script/db/hme_wip_stocktake_doc_his.groovy') {
    changeSet(author: "chaonan.hu@hand-china.com", id: "2021-03-03-hme_wip_stocktake_doc_his") {
        def weight = 1
        ...
        if(helper.dbType().isSupportSequence()){
            createSequence(sequenceName: 'hme_wip_stocktake_doc_his_s', startValue:"1")
        }
        createTable(tableName: "hme_wip_stocktake_doc_his", remarks: "在制盘点单历史") {
            column(name: "stocktake_his_id", type: "varchar(" + 100 * weight + ")",  remarks: "主键")  {constraints(primaryKey: true)} 
            ...
            column(name: "identification", type: "varchar(" + 100 * weight + ")",  remarks: "单据条码")  {constraints(nullable:"false")}  
   ...
   createIndex(tableName: "hme_wip_stocktake_doc_his", indexName: "hme_wip_stocktake_doc_his_n1") {
            column(name: "stocktake_id")
        }
   createIndex(tableName: "hme_wip_stocktake_doc_his", indexName: "hme_wip_stocktake_doc_his_n2") {
            column(name: "site_id")
        }
   createIndex(tableName: "hme_wip_stocktake_doc_his", indexName: "hme_wip_stocktake_doc_his_n3") {
            column(name: "area_id")
        }
