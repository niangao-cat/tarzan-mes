...
databaseChangeLog(logicalFilePath: 'script/db/hme_cos_test_monitor_record.groovy') {
changeSet(author: "wengang.qiang@hand-china.com", id: "2021-09-16-hme_cos_test_monitor_record") {
    def weight = 1
    ...
    if(helper.dbType().isSupportSequence()){
        createSequence(sequenceName: 'hme_cos_test_monitor_record_s', startValue:"1")
    }
    createTable(tableName: "hme_cos_test_monitor_record", remarks: "COS测试良率监控记录表") {
        column(name: "tenant_id", type: "bigint",  remarks: "租户id")  {constraints(nullable:"false")}  
        column(name: "cos_monitor_record_id", type: "varchar(" + 100 * weight + ")",  remarks: "主键")  {constraints(primaryKey: true)} 
        column(name: "cos_monitor_header_id", type: "varchar(" + 100 * weight + ")",  remarks: "cos测试良率监控表ID")  {constraints(nullable:"false")}  
        column(name: "monitor_doc_num", type: "varchar(" + 100 * weight + ")",  remarks: "监控单据")  {constraints(nullable:"false")}  
