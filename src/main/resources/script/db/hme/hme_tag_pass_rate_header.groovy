...
databaseChangeLog(logicalFilePath: 'script/db/hme_tag_pass_rate_header.groovy') {
changeSet(author: "wengang.qiang@hand-china.com", id: "2021-09-15-hme_tag_pass_rate_header") {
    def weight = 1
    ...
    if(helper.dbType().isSupportSequence()){
        createSequence(sequenceName: 'hme_tag_pass_rate_header_s', startValue:"1")
    }
    createTable(tableName: "hme_tag_pass_rate_header", remarks: "偏振度和发散角良率维护头表") {
        ...
        column(name: "ATTRIBUTE15", type: "varchar(" + 150 * weight + ")",  remarks: "")   
            ...
            addUniqueConstraint(columnNames:"cos_type,test_object,tenant_id",tableName:"hme_tag_pass_rate_header",constraintName: "hme_tag_pass_rate_header_u1")
            }
}