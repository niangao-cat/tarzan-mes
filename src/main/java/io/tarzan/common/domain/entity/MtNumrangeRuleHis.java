 ...
 */
@ApiModel("号码段定义组合规则历史表")
@ModifyAudit

@Table(name = "mt_numrange_rule_his")
@CustomPrimary
public class MtNumrangeRuleHis extends AuditDomain {

    public static final String FIELD_TENANT_ID = "tenantId";
    public static final String FIELD_NUMRANGE_RULE_HIS_ID = "numrangeRuleHisId";
    ...
    @ApiModelProperty("号码段定义组合规则历史表主键")
    @Id
    @Where
    private String numrangeRuleHisId;
    @ApiModelProperty(value = "号码段定义组合规则表主键", required = true)
    @NotBlank
    @Where
    ...
    @ApiModelProperty(value = "序列号层级", required = true)
    @Where
    ...
    @ApiModelProperty(value = "标准对象编码ID")
    @Where
    ...
    /**
     * @return 号码段定义组合规则历史表主键
     */
    public String getNumrangeRuleHisId() {
        return numrangeRuleHisId;
    }

    public void setNumrangeRuleHisId(String numrangeRuleHisId) {
        this.numrangeRuleHisId = numrangeRuleHisId;
    }
