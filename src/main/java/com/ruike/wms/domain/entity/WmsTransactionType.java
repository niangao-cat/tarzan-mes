...
@Table(name = "wms_transaction_type")
@CustomPrimary
public class WmsTransactionType extends AuditDomain {
    ...
    public static final String FIELD_PROCESS_ERP_FLAG = "processErpFlag";
    ...
    @ApiModelProperty(value = "是否回传ERP", required = true)
    @NotBlank
    private String processErpFlag;
    @ApiModelProperty(value = "SAP移动事务分配代码")
     ...
     * @return 是否回传ERP
     */
    public String getProcessErpFlag() {
        return processErpFlag;
    }

    public void setProcessErpFlag(String processErpFlag) {
        this.processErpFlag = processErpFlag;
    }
