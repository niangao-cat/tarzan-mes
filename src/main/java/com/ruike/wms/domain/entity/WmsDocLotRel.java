...
@Table(name = "wms_doc_lot_rel")
@CustomPrimary
public class WmsDocLotRel extends AuditDomain {
    ...
    public static final String FIELD_DOC_DETAIL_ID = "docDetailId";
     ...
     * @return 主键
     */
    public String getDocRelId() {
        return docRelId;
    }

    public void setDocRelId(String docRelId) {
        this.docRelId = docRelId;
    }
