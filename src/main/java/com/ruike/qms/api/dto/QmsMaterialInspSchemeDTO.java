 ...
 * 物料检验复制按钮传输参数
 *
 * @author wenqiang.yin@hand-china.com 2021/02/07 10:53
 */
@Data
public class QmsMaterialInspSchemeDTO implements Serializable {

    private static final long serialVersionUID = 4846933953817197212L;
