...
@Table(name = "qms_pqc_line_his")
public class QmsPqcLineHis extends AuditDomain {

    public static final String FIELD_TENANT_ID = "tenantId";
    public static final String FIELD_PQC_HEADER_ID = "pqcHeaderId";
    public static final String FIELD_PQC_LINE_HIS_ID = "pqcLineHisId";
    ...
    @ApiModelProperty("检验单行历史主键ID")
    @Id
    private String pqcLineHisId;
     ...
     * @return 检验单行历史主键ID
     */
    public String getPqcLineHisId() {
        return pqcLineHisId;
    }

    public void setPqcLineHisId(String pqcLineHisId) {
        this.pqcLineHisId = pqcLineHisId;
    }
