...
@Table(name = "qms_material_tag_group_rel")
@CustomPrimary
public class QmsMaterialTagGroupRel extends AuditDomain {

    public static final String FIELD_TENANT_ID = "tenantId";
    public static final String FIELD_TAG_GROUP_REL_ID = "tagGroupRelId";
   ...
   @ApiModelProperty(value = "")    
     ...
     */
	public String getTagGroupRelId() {
		return tagGroupRelId;
	}

	public void setTagGroupRelId(String tagGroupRelId) {
		this.tagGroupRelId = tagGroupRelId;
	}
    /**
     * @return 物料检验计划主键id
     */
