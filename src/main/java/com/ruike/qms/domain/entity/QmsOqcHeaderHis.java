...
@Table(name = "qms_oqc_header_his")
public class QmsOqcHeaderHis extends AuditDomain {

    public static final String FIELD_TENANT_ID = "tenantId";
    public static final String FIELD_EVENT_ID = "eventId";
    public static final String FIELD_SITE_ID = "siteId";
    public static final String FIELD_OQC_HEADER_HIS_ID = "oqcHeaderHisId";
    ...
    @ApiModelProperty(value = "检验单头表历史表主键")
	@Id
	@GeneratedValue
    private String oqcHeaderHisId;
     ...
     * @return 检验单头表历史表主键
     */
	public String getOqcHeaderHisId() {
		return oqcHeaderHisId;
	}

	public void setOqcHeaderHisId(String oqcHeaderHisId) {
		this.oqcHeaderHisId = oqcHeaderHisId;
	}
    /**
     * @return 检验单头表主键
     */
