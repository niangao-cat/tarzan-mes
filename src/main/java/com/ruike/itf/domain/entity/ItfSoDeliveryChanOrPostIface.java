 ...
 */
@ApiModel("交货单修改过账接口头表")
@VersionAudit
@ModifyAudit
@JsonInclude(value = JsonInclude.Include.NON_NULL)
@Table(name = "itf_so_delivery_chan_or_post_iface")
@CustomPrimary
public class ItfSoDeliveryChanOrPostIface extends AuditDomain {
    ...
    public static final String FIELD_H_RETURN_STATUS = "hReturnStatus";
   ...
   @ApiModelProperty(value = "")    
     ...
     * @return 头回传状态
     */
	public String gethReturnStatus() {
		return hReturnStatus;
	}

	public void sethReturnStatus(String hReturnStatus) {
		this.hReturnStatus = hReturnStatus;
	}
    /**
     * @return 处理类型
     */
