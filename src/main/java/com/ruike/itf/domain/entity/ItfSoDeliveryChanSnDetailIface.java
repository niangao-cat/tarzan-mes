...
@Table(name = "itf_so_delivery_chan_sn_detail_iface")
@CustomPrimary
public class ItfSoDeliveryChanSnDetailIface extends AuditDomain {

    public static final String FIELD_TENANT_ID = "tenantId";
    public static final String FIELD_LINE_ID = "lineId";
    public static final String FIELD_LINE_SN_DETAIL_ID = "lineSnDetailId";
   ...
   @ApiModelProperty(value = "")    
     ...
     * @return 主键ID
     */
	public String getLineSnDetailId() {
		return lineSnDetailId;
	}

	public void setLineSnDetailId(String lineSnDetailId) {
		this.lineSnDetailId = lineSnDetailId;
	}
    /**
     * @return 单据号
     */
