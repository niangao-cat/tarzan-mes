 ...
 * 拓展表
 *
 * @author kejin.liu01@hand-china.com 2020-08-12 12:35:03
 */
@ApiModel("拓展表")
@VersionAudit
@ModifyAudit
@JsonInclude(value = JsonInclude.Include.NON_NULL)
@Table(name = "mt_instruction_doc_attr")
@Data
@CustomPrimary
public class ItfInstructionDocAttr extends AuditDomain {

    public static final String FIELD_TENANT_ID = "tenantId";
    public static final String FIELD_ATTR_ID = "attrId";
    public static final String FIELD_STOCKTAKE_ID = "instructionDocId";
