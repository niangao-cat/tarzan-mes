 ...
 */
@ImportService(templateCode = "HME.MATERIAL_LOT_THREE")
@Slf4j
public class HmeImportMaterialLotThreeServiceImpl extends ImportHandler {
    @Autowired
    ...
    public Boolean doImport(String vo) {
        ...
        if (!StringUtils.isEmpty(importVO.getContainerCode())) {
