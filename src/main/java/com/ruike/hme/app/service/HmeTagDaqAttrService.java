 ...
 */
public interface HmeTagDaqAttrService {
     ...
     * @param tenantId 租户ID
     * @param dto 保存数据
     * @author chaonan.hu chaonan.hu@hand-china.com 2020/7/21 11:32:34
     ...
     * @param tenantId 租户ID
     * @param tagId 数据项ID
     * @author chaonan.hu chaonan.hu@hand-china.com 2020/7/21 13:44:26
