 ...
 * 光纤质量文件导入
 * @author: chaonan.hu@hand-china.com 2021-01-20 09:32:45
 **/
@ImportValidators({
        @ImportValidator(templateCode = "HME.APLASER_QUALITY_DOC")
})
public class HmeAplaserQualityDocValidator extends ValidatorHandler {
    ...
    public boolean validate(String data) {
        ...
        if(StringUtils.isNotBlank(data)){
            ...
            try {
                importVO = objectMapper.readValue(data, HmeAplaserQualityDocDTO.class);
            } catch (IOException e) {
                // 失败
                return false;
            }
     ...
     * @param tenantId 租户ID
     * @param importVO 导入数据
     * @author chaonan.hu chaonan.hu@hand-china.com 2021/01/20 09:40:23
     * @return java.lang.Boolean
     */
    private Boolean importDataValidate(Long tenantId, HmeAplaserQualityDocDTO importVO) {
        boolean flag = true;
        //物料编码校验
