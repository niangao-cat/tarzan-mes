 ...
 */
@JobHandler("hmeCreateTaskByMonthJob")
public class HmeEqCheckByMonthJobHandler implements IJobHandler {
    ...
    public ReturnT execute(Map<String, String> map, SchedulerTool tool) {
        ...
        try {
            this.hmeEqManageTaskDocService.createEqTaskDoc(tenantId, HmeConstants.Cycle.MONTH);
