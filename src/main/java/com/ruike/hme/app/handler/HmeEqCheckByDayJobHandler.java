 ...
 */
@JobHandler("hmeCreateTaskByDayJob")
public class HmeEqCheckByDayJobHandler implements IJobHandler {
    ...
    public ReturnT execute(Map<String, String> map, SchedulerTool tool) {
        ...
        try {
            this.hmeEqManageTaskDocService.createEqTaskDoc(tenantId, HmeConstants.Cycle.DAY);
