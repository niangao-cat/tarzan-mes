 ...
 */
@JobHandler("hmeCreateTaskByWeekJob")
public class HmeEqCheckByWeekJobHandler implements IJobHandler {
    ...
    public ReturnT execute(Map<String, String> map, SchedulerTool tool) {
        ...
        try {
            this.hmeEqManageTaskDocService.createEqTaskDoc(tenantId, HmeConstants.Cycle.WEEK);
