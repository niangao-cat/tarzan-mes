...
@Table(name = "hme_pre_selection")
@CustomPrimary
public class HmePreSelection extends AuditDomain {

    public static final String FIELD_TENANT_ID = "tenantId";
    public static final String FIELD_PRE_SELECTION_ID = "preSelectionId";
    public static final String FIELD_SITE_ID = "siteId";
    public static final String FIELD_PRE_SELECTION_LOT = "preSelectionLot";
    ...
    @ApiModelProperty(value = "预挑选批次",required = true)
    @NotBlank
   ...
   @ApiModelProperty(value = "")    
     ...
     * @return 预挑选批次
     */
	public String getPreSelectionLot() {
		return preSelectionLot;
	}

	public void setPreSelectionLot(String preSelectionLot) {
		this.preSelectionLot = preSelectionLot;
	}
    /**
     * @return 套数
     */
