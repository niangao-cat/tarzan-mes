...
@Table(name = "hme_wkc_complete_output_record")
public class HmeWkcCompleteOutputRecord extends AuditDomain {

    public static final String FIELD_TENANT_ID = "tenantId";
    public static final String FIELD_WKC_OUTPUT_RECORD_ID = "wkcOutputRecordId";
    ...
    @Id
    @GeneratedValue
    private String wkcOutputRecordId;
     ...
     * @return 主键id
     */
	public String getWkcOutputRecordId() {
		return wkcOutputRecordId;
	}

	public void setWkcOutputRecordId(String wkcOutputRecordId) {
		this.wkcOutputRecordId = wkcOutputRecordId;
	}
    /**
     * @return 站点ID
     */
