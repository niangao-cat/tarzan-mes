 ...
 */
@ApiModel("泵浦源筛选规则头表历史表")
@VersionAudit
@ModifyAudit
@JsonInclude(value = JsonInclude.Include.NON_NULL)
@Table(name = "hme_pump_filter_rule_header_his")
@CustomPrimary
public class HmePumpFilterRuleHeaderHis extends AuditDomain {

    public static final String FIELD_TENANT_ID = "tenantId";
    public static final String FIELD_RULE_HEAD_HIS_ID = "ruleHeadHisId";
