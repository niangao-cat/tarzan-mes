 ...
 * 营销服务部接收拆箱登记历史表
 *
 * @author chaonan.hu@hand-china.com 2020-09-04 14:46:27
 */
@ApiModel("营销服务部接收拆箱登记历史表")
@VersionAudit
@ModifyAudit
@CustomPrimary
@JsonInclude(value = JsonInclude.Include.NON_NULL)
@Table(name = "hme_service_receive_his")
public class HmeServiceReceiveHis extends AuditDomain {

    public static final String FIELD_TENANT_ID = "tenantId";
    public static final String FIELD_SITE_ID = "siteId";
    public static final String FIELD_SERVICE_RECEIVE_HIS_ID = "serviceReceiveHisId";
    ...
    @Id
    private String serviceReceiveHisId;
     ...
     * @return 历史表主键
     */
    public String getServiceReceiveHisId() {
        return serviceReceiveHisId;
    }

    public void setServiceReceiveHisId(String serviceReceiveHisId) {
        this.serviceReceiveHisId = serviceReceiveHisId;
    }
