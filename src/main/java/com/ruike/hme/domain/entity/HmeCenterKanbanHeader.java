...
@Table(name = "hme_center_kanban_header")
public class HmeCenterKanbanHeader extends AuditDomain {

    public static final String FIELD_TENANT_ID = "tenantId";
    public static final String FIELD_CENTER_KANBAN_HEADER_ID = "centerKanbanHeaderId";
    public static final String FIELD_SITE_ID = "siteId";
    public static final String FIELD_KANBAN_AREA = "kanbanArea";
     ...
     * @return 主键ID
     */
	public String getCenterKanbanHeaderId() {
		return centerKanbanHeaderId;
	}

	public void setCenterKanbanHeaderId(String centerKanbanHeaderId) {
		this.centerKanbanHeaderId = centerKanbanHeaderId;
	}
    /**
     * @return 站点ID
     */
	...
	public void setKanbanArea(String kanbanArea) {
		this.kanbanArea = kanbanArea;
	}
    /**
     * @return 产线ID
     */
