...
@NoArgsConstructor
@ToString
@Table(name = "hme_eo_job_material")
@CustomPrimary
public class HmeEoJobMaterial extends AuditDomain implements Serializable {
    ...
    public static final String FIELD_IS_BACKFLUSH = "isBackflush";
    ...
    public static final String FIELD_IS_ISSUED = "isIssued";
    ...
    @ApiModelProperty(value = "组件条码ID",required = true)
    ...
    private Integer isBackflush;
    @ApiModelProperty(value = "EO")
    private String eoId;
    @ApiModelProperty(value = "组件装配ID")
