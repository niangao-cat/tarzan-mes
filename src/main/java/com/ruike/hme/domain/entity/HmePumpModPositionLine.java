...
@Table(name = "hme_pump_mod_position_line")
@CustomPrimary
public class HmePumpModPositionLine extends AuditDomain {

    public static final String FIELD_TENANT_ID = "tenantId";
    public static final String FIELD_POSITION_LINE_ID = "positionLineId";
    public static final String FIELD_POSITION_HEADER_ID = "positionHeaderId";
    ...
    @NotBlank
    private String positionHeaderId;
    @ApiModelProperty(value = "泵浦源物料批ID",required = true)
    @NotBlank
    private String materialLotId;
    @ApiModelProperty(value = "子条码排序",required = true)
    @NotNull
   ...
   @ApiModelProperty(value = "")    
     ...
     * @return 头表主键
     */
	public String getPositionHeaderId() {
		return positionHeaderId;
	}

	public void setPositionHeaderId(String positionHeaderId) {
