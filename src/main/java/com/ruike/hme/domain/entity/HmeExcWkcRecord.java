 ...
 * 工序异常反馈记录表
 *
 * @author liyuan.lv@hand-china.com 2020-05-13 14:43:28
 */
@ApiModel("工序异常反馈记录表")
@VersionAudit
@ModifyAudit
...
@Table(name = "hme_exc_wkc_record")
@CustomPrimary
public class HmeExcWkcRecord extends AuditDomain {
