...
@Table(name = "hme_wkc_eo_rel")
public class HmeWkcEoRel extends AuditDomain {

    public static final String FIELD_WKC_EO_REL_ID = "wkcEoRelId";
   ...
   @ApiModelProperty(value = "")    
     ...
     * @return 表ID，主键
     */
	public String getWkcEoRelId() {
		return wkcEoRelId;
	}

	public void setWkcEoRelId(String wkcEoRelId) {
		this.wkcEoRelId = wkcEoRelId;
	}
    /**
     * @return 租户id
     */
