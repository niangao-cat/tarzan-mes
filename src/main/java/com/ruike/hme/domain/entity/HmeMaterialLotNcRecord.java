...
@Table(name = "hme_material_lot_nc_record")
@CustomPrimary
public class HmeMaterialLotNcRecord extends AuditDomain {

    public static final String FIELD_TENANT_ID = "tenantId";
    public static final String FIELD_NC_RECORD_ID = "ncRecordId";
    public static final String FIELD_NC_LOAD_ID = "ncLoadId";
    ...
    @ApiModelProperty(value = "不良位置Id",required = true)
	@NotBlank
   ...
   @ApiModelProperty(value = "")    
     ...
     * @return 不良位置Id
     */
	public String getNcLoadId() {
		return ncLoadId;
	}

	public void setNcLoadId(String ncLoadId) {
