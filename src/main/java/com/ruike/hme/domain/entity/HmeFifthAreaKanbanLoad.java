...
@Table(name = "hme_fifth_area_kanban_load")
@CustomPrimary
public class HmeFifthAreaKanbanLoad extends AuditDomain {

    public static final String FIELD_TENANT_ID = "tenantId";
    public static final String FIELD_FIFTH_AREA_KANBAN_LOAD_ID = "fifthAreaKanbanLoadId";
    ...
    @Id
    private String fifthAreaKanbanLoadId;
    ...
    @ApiModelProperty(value = "热枕供应商批次")
    private String hotSupplierLot;
   ...
   @ApiModelProperty(value = "")    
     ...
     * @return 主键ID
     */
	public String getFifthAreaKanbanLoadId() {
		return fifthAreaKanbanLoadId;
	}

	public void setFifthAreaKanbanLoadId(String fifthAreaKanbanLoadId) {
		this.fifthAreaKanbanLoadId = fifthAreaKanbanLoadId;
	}
    /**
     * @return EOID
     */
     ...
     * @return 热枕供应商批次
     */
	public String getHotSupplierLot() {
		return hotSupplierLot;
	}

	public void setHotSupplierLot(String hotSupplierLot) {
		this.hotSupplierLot = hotSupplierLot;
	}
    /**
     * @return 虚拟号
     */
