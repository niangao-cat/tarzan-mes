...
@Table(name = "hme_operation_time_his")
public class HmeOperationTimeHis extends AuditDomain {

    public static final String FIELD_TENANT_ID = "tenantId";
    public static final String FIELD_OPERATION_TIME_HIS_ID = "operationTimeHisId";
    ...
    @Id
//    @GeneratedValue
    private String operationTimeHisId;
     ...
     * @return 主键
     */
    public String getOperationTimeHisId() {
        return operationTimeHisId;
    }

    public void setOperationTimeHisId(String operationTimeHisId) {
        this.operationTimeHisId = operationTimeHisId;
    }
