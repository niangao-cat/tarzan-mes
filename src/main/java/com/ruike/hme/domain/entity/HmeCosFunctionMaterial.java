 ...
 * COS投料性能表
 *
 * @author penglin.sui@hand-china.com 2021-06-24 11:14:23
 */
@ApiModel("COS投料性能表")
@VersionAudit
@ModifyAudit
@JsonInclude(value = JsonInclude.Include.NON_NULL)
@Table(name = "hme_cos_function_material")
@CustomPrimary
public class HmeCosFunctionMaterial extends AuditDomain {

	public static final String FIELD_TENANT_ID = "tenantId";
	public static final String FIELD_COS_FUNCTION_MATERIAL_ID = "cosFunctionMaterialId";
	...
	@NotBlank
	@Id
	private String cosFunctionMaterialId;
	...
	@ApiModelProperty(value = "功率等级",required = true)
	@NotBlank
	private String a01;
	@ApiModelProperty(value = "功率/w",required = true)
	@NotNull
	 ...
	 * @return 主键ID
	 */
	public String getCosFunctionMaterialId() {
		return cosFunctionMaterialId;
	}

	public void setCosFunctionMaterialId(String cosFunctionMaterialId) {
		this.cosFunctionMaterialId = cosFunctionMaterialId;
	}
	/**
	 * @return 芯片序列号
	 */
