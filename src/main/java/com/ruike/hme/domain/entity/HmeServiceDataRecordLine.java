...
@Table(name = "hme_service_data_record_line")
@CustomPrimary
public class HmeServiceDataRecordLine extends AuditDomain {

    public static final String FIELD_TENANT_ID = "tenantId";
    public static final String FIELD_SERVICE_DATA_RECORD_LINE_ID = "serviceDataRecordLineId";
     ...
     * @return 主键id
     */
	public String getServiceDataRecordLineId() {
		return serviceDataRecordLineId;
	}

	public void setServiceDataRecordLineId(String serviceDataRecordLineId) {
		this.serviceDataRecordLineId = serviceDataRecordLineId;
	}
    /**
     * @return 头表id
     */
