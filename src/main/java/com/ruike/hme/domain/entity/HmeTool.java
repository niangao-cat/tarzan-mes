...
@Table(name = "hme_tool")
@CustomPrimary
public class HmeTool extends AuditDomain {
   ...
   @ApiModelProperty(value = "频率")    
	...
	@LovValue(value = "HME.APPLY_TYPE", meaningField = "applyTypeMeaning")
   ...
   @ApiModelProperty(value = "")    
	...
	public String getApplyTypeMeaning() {
		return applyTypeMeaning;
	}

	public void setApplyTypeMeaning(String applyTypeMeaning) {
		this.applyTypeMeaning = applyTypeMeaning;
	}
    /**
     * @return 有效标识
     */
