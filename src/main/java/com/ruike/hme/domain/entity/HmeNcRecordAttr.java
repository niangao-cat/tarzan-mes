...
@Table(name = "hme_nc_record_attr")
public class HmeNcRecordAttr extends AuditDomain {

    public static final String FIELD_TENANT_ID = "tenantId";
    public static final String FIELD_ATTR_ID = "attrId";
    public static final String FIELD_PARENT_RECORD_ID = "parentRecordId";
    public static final String FIELD_RECORD_ID = "recordId";
    public static final String FIELD_PROCESS_METHOD = "processMethod";
...
//    @GeneratedValue
    ...
    @ApiModelProperty(value = "子不良记录ID")
