...
@Table(name = "hme_exception_router")
@CustomPrimary
public class HmeExceptionRouter extends AuditDomain {

    public static final String FIELD_TENANT_ID = "tenantId";
    public static final String FIELD_EXCEPTION_ROUTER_ID = "exceptionRouterId";
