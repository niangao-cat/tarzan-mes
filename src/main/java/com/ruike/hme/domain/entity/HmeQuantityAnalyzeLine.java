...
@Table(name = "hme_quantity_analyze_line")
public class HmeQuantityAnalyzeLine extends AuditDomain {

    public static final String FIELD_TENANT_ID = "tenantId";
    public static final String FIELD_QA_DOC_ID = "qaDocId";
    public static final String FIELD_QA_LINE_ID = "qaLineId";
	...
	public static final int DYNAMIC_COLUMNS = 150;
	public static final int TEST_COLUMNS = 100;
     ...
     * @return 主键
     */
	public String getQaLineId() {
		return qaLineId;
	}

	public void setQaLineId(String qaLineId) {
		this.qaLineId = qaLineId;
	}
    /**
     * @return 数据项编码
     */
