...
@Table(name = "hme_op_eq_rel")
public class HmeOpEqRel extends AuditDomain {

    public static final String FIELD_OP_EQ_REL_ID = "opEqRelId";
    ...
    @ApiModelProperty(value = "设备类别编码",required = true)
   ...
   @ApiModelProperty(value = "")    
     ...
     * @return 主键
     */
	public String getOpEqRelId() {
		return opEqRelId;
	}

	public void setOpEqRelId(String opEqRelId) {
		this.opEqRelId = opEqRelId;
	}
    /**
     * @return 租户ID
     */
