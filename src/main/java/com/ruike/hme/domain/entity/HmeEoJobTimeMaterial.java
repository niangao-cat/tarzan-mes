...
@NoArgsConstructor
@ToString
@Table(name = "hme_eo_job_time_material")
@CustomPrimary
public class HmeEoJobTimeMaterial extends AuditDomain implements Serializable {
    ...
    public static final String FIELD_DEAD_LINE_DATE = "deadLineDate";
