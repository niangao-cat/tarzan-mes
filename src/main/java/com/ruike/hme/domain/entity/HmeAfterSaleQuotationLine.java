...
@Table(name = "hme_after_sale_quotation_line")
public class HmeAfterSaleQuotationLine extends AuditDomain {
    ...
    public static final String FIELD_DEMAND_TYPE = "demandType";
    public static final String FIELD_MATERIAL_ID = "materialId";
    public static final String FIELD_REQUSET_QTY = "requsetQty";
    ...
    @ApiModelProperty(value = "报价单头id",required = true)
    @NotBlank
     ...
     * @return 数量
     */
	public BigDecimal getRequsetQty() {
		return requsetQty;
	}

	public void setRequsetQty(BigDecimal requsetQty) {
		this.requsetQty = requsetQty;
	}
    /**
     * @return 备注
     */
