...
@Table(name = "hme_logistics_info_his")
public class HmeLogisticsInfoHis extends AuditDomain {

    public static final String FIELD_TENANT_ID = "tenantId";
    public static final String FIELD_LOGISTICS_INFO_HIS_ID = "logisticsInfoHisId";
    ...
    @Id
//    @GeneratedValue
    private String logisticsInfoHisId;
    @ApiModelProperty(value = "物流信息ID", required = true)
    @NotBlank
     ...
     * @return 主键
     */
    public String getLogisticsInfoHisId() {
        return logisticsInfoHisId;
    }

    public void setLogisticsInfoHisId(String logisticsInfoHisId) {
        this.logisticsInfoHisId = logisticsInfoHisId;
    }
