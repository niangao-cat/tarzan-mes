...
@Table(name = "hme_production_group")
public class HmeProductionGroup extends AuditDomain {

    public static final String FIELD_TENANT_ID = "tenantId";
    public static final String FIELD_PRODUCTION_GROUP_ID = "productionGroupId";
    public static final String FIELD_SITE_ID = "siteId";
    public static final String FIELD_PRODUCTION_GROUP_CODE = "productionGroupCode";
