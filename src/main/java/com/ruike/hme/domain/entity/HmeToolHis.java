...
@Table(name = "hme_tool_his")
@CustomPrimary
public class HmeToolHis extends AuditDomain {

    public static final String FIELD_TOOL_HIS_ID = "toolHisId";
   ...
   @ApiModelProperty(value = "")    
     ...
     * @return 主键
     */
	public String getToolHisId() {
		return toolHisId;
	}

	public void setToolHisId(String toolHisId) {
		this.toolHisId = toolHisId;
	}
    /**
     * @return 工装ID
     */
