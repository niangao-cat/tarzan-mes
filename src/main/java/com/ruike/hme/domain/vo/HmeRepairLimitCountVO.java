...
/**
 * @author yaqiong.zhou@raycus.com 2021/9/7 10:08
 */
@Setter
@Getter
@AllArgsConstructor
...
@ToString
@Data
public class HmeRepairLimitCountVO implements Serializable {
    private static final long serialVersionUID = 214333484070274485L;
