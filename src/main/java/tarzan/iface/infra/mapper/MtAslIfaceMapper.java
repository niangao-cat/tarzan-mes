...
/**
 * 合格供应商（货源清单）数据接口Mapper
 *
 * @author mingjie.chen@hand-china.com 2019-09-09 17:05:24
 */
public interface MtAslIfaceMapper extends BaseMapper<MtAslIface> {
     ...
     * @return List
     */
    List<MtAslIface> getUnprocessedList(@Param(value = "tenantId") Long tenantId);
}
