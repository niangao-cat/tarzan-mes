 ...
 */
@ApiModel("数据收集项分配收集组历史表")

@ModifyAudit

@Table(name = "mt_tag_group_assign_his")
@CustomPrimary
public class MtTagGroupAssignHis extends AuditDomain {

    public static final String FIELD_TENANT_ID = "tenantId";
    public static final String FIELD_TAG_GROUP_ASSIGN_HIS_ID = "tagGroupAssignHisId";
    ...
    @ApiModelProperty(value = "数据收集项分配收集组ID", required = true)
    @NotBlank
    @Where
