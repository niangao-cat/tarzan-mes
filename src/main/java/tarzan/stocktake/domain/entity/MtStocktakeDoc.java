...
@Table(name = "mt_stocktake_doc")
@CustomPrimary
public class MtStocktakeDoc extends AuditDomain implements Serializable {
    ...
    private static final long serialVersionUID = -8688701811842175460L;
