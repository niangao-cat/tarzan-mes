...
/**
 * 区域维护-新增 使用DTO(包含计划属性、采购属性)
 * 
 * @author benjamin
 */
public class MtModAreaDTO3 implements Serializable {
    ...
    private List<MtExtendAttrDTO3> areaAttrList;
    ...
    public List<MtExtendAttrDTO3> getAreaAttrList() {
        return areaAttrList;
    }

    public void setAreaAttrList(List<MtExtendAttrDTO3> areaAttrList) {
