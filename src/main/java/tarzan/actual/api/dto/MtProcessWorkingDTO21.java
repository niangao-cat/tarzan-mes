 ...
 */
public class MtProcessWorkingDTO21 implements Serializable {
    private static final long serialVersionUID = 225668614715239530L;
    ...
    @ApiModelProperty("物料批ID-选择行")
    private String materialLotlId;
    ...
    public String getMaterialLotlId() {
        return materialLotlId;
    }

    public void setMaterialLotlId(String materialLotlId) {
        this.materialLotlId = materialLotlId;
    }
