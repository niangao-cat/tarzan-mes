 ...
 */
public class MtProcessWorkingDTO14 implements Serializable {
    private static final long serialVersionUID = 7929568524500322637L;
    ...
    @ApiModelProperty("行")
    List<MtProcessWorkingDTO15> mateiralLotList;
    ...
    public List<MtProcessWorkingDTO15> getMateiralLotList() {
        return mateiralLotList;
    }

    public void setMateiralLotList(List<MtProcessWorkingDTO15> mateiralLotList) {
        this.mateiralLotList = mateiralLotList;
    }
}
