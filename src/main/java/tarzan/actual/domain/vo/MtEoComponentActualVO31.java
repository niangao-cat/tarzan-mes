 ...
 */
public class MtEoComponentActualVO31 implements Serializable {
    private static final long serialVersionUID = 1436573477149209698L;
    ...
    private List<MtEoComponentActualVO30> eoInfo;
    ...
    public List<MtEoComponentActualVO30> getEoInfo() {
        return eoInfo;
    }

    public void setEoInfo(List<MtEoComponentActualVO30> eoInfo) {
        this.eoInfo = eoInfo;
    }
}
