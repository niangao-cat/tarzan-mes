...
/**
 * 装配点实绩历史，记录装配组下装配点实际装配物料和数量变更记录
 *
 * @author xinlin.zhao@hand-china.com 2019-07-30 15:58:53
 */
@ApiModel("装配点实绩历史，记录装配组下装配点实际装配物料和数量变更记录")

@ModifyAudit

@Table(name = "mt_assemble_point_actual_his")
@CustomPrimary
public class MtAssemblePointActualHis extends AuditDomain implements Serializable {

    public static final String FIELD_TENANT_ID = "tenantId";
    public static final String FIELD_ASSEMBLE_POINT_ACTUAL_HIS_ID = "assemblePointActualHisId";
    ...
    public static final String FIELD_TRX_FEEDING_QTY = "trxFeedingQty";
    public static final String FIELD_CID = "cid";
    private static final long serialVersionUID = 7848906889858158985L;
    ...
    @Id
    @Where
    private String assemblePointActualHisId;
    @ApiModelProperty(value = "装配点实绩ID，标识唯一一条装配点实际记录", required = true)
    @NotBlank
    @Where
    ...
    @ApiModelProperty(value = "事务数量-当前数量", required = true)
    @NotNull
    @Where
    private Double trxQty;
    @ApiModelProperty(value = "事务数量-初始装载数量", required = true)
    @NotNull
    @Where
