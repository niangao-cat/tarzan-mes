...
@Table(name = "mt_eo_step_actual")
@CustomPrimary
public class MtEoStepActual extends AuditDomain implements Serializable {
    ...
    private static final long serialVersionUID = 8860807596669824376L;
