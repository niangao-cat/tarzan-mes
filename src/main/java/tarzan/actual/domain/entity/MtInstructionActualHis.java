...
@Table(name = "mt_instruction_actual_his")
@CustomPrimary
public class MtInstructionActualHis extends AuditDomain implements Serializable {

    public static final String FIELD_TENANT_ID = "tenantId";
    public static final String FIELD_ACTUAL_HIS_ID = "actualHisId";
    ...
    private static final long serialVersionUID = -806955035474852712L;
    ...
    @ApiModelProperty(value = "指令实绩汇总id", required = true)
    @NotBlank
    @Where
