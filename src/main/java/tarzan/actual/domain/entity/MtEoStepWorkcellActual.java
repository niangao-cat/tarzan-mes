 ...
 */
@ApiModel("执行作业-工艺路线步骤执行明细")

@ModifyAudit
@JsonInclude(value = JsonInclude.Include.NON_NULL)
@Table(name = "mt_eo_step_workcell_actual")
@CustomPrimary
public class MtEoStepWorkcellActual extends AuditDomain implements Serializable {
    ...
    private static final long serialVersionUID = -5502593024613008113L;
