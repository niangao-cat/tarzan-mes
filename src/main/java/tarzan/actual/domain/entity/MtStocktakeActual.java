...
@Table(name = "mt_stocktake_actual")
@CustomPrimary
public class MtStocktakeActual extends AuditDomain implements Serializable {
    ...
    private static final long serialVersionUID = 5238702455668054326L;
    ...
    public MtStocktakeActual setLatestHisId(String latestHisId) {
