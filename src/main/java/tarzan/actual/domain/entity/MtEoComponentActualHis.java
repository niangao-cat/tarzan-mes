...
/**
 * 执行作业组件装配实绩历史，记录执行作业物料和组件实际装配情况变更历史
 *
 * @author xinlin.zhao@hand-china.com 2019-07-30 15:58:53
 */
@ApiModel("执行作业组件装配实绩历史，记录执行作业物料和组件实际装配情况变更历史")

@ModifyAudit
@JsonInclude(value = JsonInclude.Include.NON_NULL)
@Table(name = "mt_eo_component_actual_his")
@CustomPrimary
public class MtEoComponentActualHis extends AuditDomain implements Serializable {

    public static final String FIELD_TENANT_ID = "tenantId";
    public static final String FIELD_EO_COMPONENT_ACTUAL_HIS_ID = "eoComponentActualHisId";
    ...
    private static final long serialVersionUID = 9126437405542278746L;
    ...
    @ApiModelProperty("执行作业组件实绩历史ID")
    @Id
    @Where
    private String eoComponentActualHisId;
    @ApiModelProperty(value = "执行作业组件实绩ID", required = true)
    @NotBlank
    @Where
     ...
     * @return 执行作业组件实绩历史ID
     */
    public String getEoComponentActualHisId() {
        return eoComponentActualHisId;
    }

    public void setEoComponentActualHisId(String eoComponentActualHisId) {
        this.eoComponentActualHisId = eoComponentActualHisId;
    }
