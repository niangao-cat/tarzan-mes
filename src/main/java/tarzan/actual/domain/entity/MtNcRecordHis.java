...
@Table(name = "mt_nc_record_his")
@CustomPrimary
public class MtNcRecordHis extends AuditDomain implements Serializable {

    public static final String FIELD_TENANT_ID = "tenantId";
    public static final String FIELD_NC_RECORD_HIS_ID = "ncRecordHisId";
    ...
    private static final long serialVersionUID = 332365819072886344L;
    ...
    @ApiModelProperty(value = "不良记录", required = true)
    @NotBlank
    @Where
    ...
    @ApiModelProperty(value = "Y/N,是否必须被关闭", required = true)
    @NotBlank
    @Where
    ...
    @ApiModelProperty(value = "事件唯一标识", required = true)
    @NotBlank
    @Where
