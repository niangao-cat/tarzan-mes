...
@ApiModel("执行作业实绩历史")
@ModifyAudit
@Table(name = "mt_eo_actual_his")
@CustomPrimary
public class MtEoActualHis extends AuditDomain implements Serializable {

    public static final String FIELD_TENANT_ID = "tenantId";
    public static final String FIELD_EO_ACTUAL_HIS_ID = "eoActualHisId";
    ...
    private static final long serialVersionUID = -7136343968029608027L;
    ...
    @ApiModelProperty("主键，唯一性标识")
    @Id
    @Where
    private String eoActualHisId;
    @ApiModelProperty(value = "主键，标识唯一一条执行作业实绩记录", required = true)
    @NotBlank
    @Where
    ...
    @ApiModelProperty(value = "事务数量-完工数量", required = true)
    @NotNull
    @Where
    ...
    @ApiModelProperty(value = "事务数量-保留数量", required = true)
    @NotNull
    @Where
