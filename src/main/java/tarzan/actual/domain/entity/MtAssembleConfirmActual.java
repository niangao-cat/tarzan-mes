...
/**
 * 装配确认实绩，指示执行作业组件材料的装配和确认情况
 *
 * @author xinlin.zhao@hand-china.com 2019-07-30 15:58:53
 */
@ApiModel("装配确认实绩，指示执行作业组件材料的装配和确认情况")

@ModifyAudit

@Table(name = "mt_assemble_confirm_actual")
@CustomPrimary
public class MtAssembleConfirmActual extends AuditDomain implements Serializable {
    ...
    private static final long serialVersionUID = 6694072847362076344L;
