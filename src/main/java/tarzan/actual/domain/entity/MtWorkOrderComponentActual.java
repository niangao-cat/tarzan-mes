...
/**
 * 生产订单组件装配实绩，记录生产订单物料和组件实际装配情况
 *
 * @author xinlin.zhao@hand-china.com 2019-07-30 15:58:53
 */
@ApiModel("生产订单组件装配实绩，记录生产订单物料和组件实际装配情况")

@ModifyAudit
@JsonInclude(value = JsonInclude.Include.NON_NULL)
@Table(name = "mt_work_order_component_actual")
@CustomPrimary
public class MtWorkOrderComponentActual extends AuditDomain implements Serializable {
    ...
    private static final long serialVersionUID = -4879313456973239453L;
