...
@Table(name = "mt_eo_step_wip_journal")
@CustomPrimary
public class MtEoStepWipJournal extends AuditDomain implements Serializable {

    public static final String FIELD_TENANT_ID = "tenantId";
    public static final String FIELD_EO_STEP_WIP_JOURNAL_ID = "eoStepWipJournalId";
    ...
    private static final long serialVersionUID = 5878917212920880677L;
    ...
    @Id
    @Where
    private String eoStepWipJournalId;
    ...
    @ApiModelProperty(value = "完成数量（但由于业务原因没有在下一层排队，如验收暂存）", required = true)
    @NotNull
    @Where
     ...
     */
    public String getEoStepWipJournalId() {
        return eoStepWipJournalId;
    }

    public void setEoStepWipJournalId(String eoStepWipJournalId) {
        this.eoStepWipJournalId = eoStepWipJournalId;
    }
    ...
    /**
     * @return 完成数量（但由于业务原因没有在下一层排队，如验收暂存）
     */
