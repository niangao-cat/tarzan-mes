...
@Table(name = "mt_nc_incident_his")
@CustomPrimary
public class MtNcIncidentHis extends AuditDomain implements Serializable {

    public static final String FIELD_TENANT_ID = "tenantId";
    public static final String FIELD_NC_INCIDENT_HIS_ID = "ncIncidentHisId";
    ...
    private static final long serialVersionUID = 8770379743103670685L;
