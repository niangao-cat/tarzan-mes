...
@Table(name = "mt_data_record")
@CustomPrimary
public class MtDataRecord extends AuditDomain implements Serializable {
    ...
    private static final long serialVersionUID = -2244940463440786297L;
