...
@Table(name = "mt_pfep_manufacturing_category")
@CustomPrimary
public class MtPfepManufacturingCategory extends AuditDomain {

    public static final String FIELD_TENANT_ID = "tenantId";
    public static final String FIELD_PFEP_MANUFACTURING_CATEGORY_ID = "pfepManufacturingCategoryId";
