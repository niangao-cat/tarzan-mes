...
/**
 * 物料类别配送属性（一个WKC的物料类别和物料不能有从属关系）
 *
 * @author yiyang.xie 2020-02-04 15:52:02
 */
@ApiModel("物料类别配送属性（一个WKC的物料类别和物料不能有从属关系）")
@ModifyAudit
@Table(name = "mt_pfep_distribution_category")
@CustomPrimary
public class MtPfepDistributionCategory extends AuditDomain {

    public static final String FIELD_TENANT_ID = "tenantId";
    public static final String FIELD_PFEP_DISTRIBUTION_CATEGORY_ID = "pfepDistributionCategoryId";
    ...
    @ApiModelProperty(value = "物料类别站点主键，标识唯一物料类别站点对应关系，限定为生产站点", required = true)
    @NotBlank
    @Where
    ...
    /**
     * @return 物料类别站点主键，标识唯一物料类别站点对应关系，限定为生产站点
     */
