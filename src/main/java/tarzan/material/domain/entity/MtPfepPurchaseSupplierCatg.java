 ...
 */
@ApiModel("物料类别供应商采购属性")

@ModifyAudit
@JsonInclude(value = JsonInclude.Include.NON_NULL)
@Table(name = "mt_pfep_purchase_supplier_catg")
@CustomPrimary
public class MtPfepPurchaseSupplierCatg extends AuditDomain {

    public static final String FIELD_TENANT_ID = "tenantId";
    public static final String FIELD_PFEP_PURCHASE_SUPPLIER_CATG_ID = "pfepPurchaseSupplierCatgId";
    ...
    @Id
    @Where
    private String pfepPurchaseSupplierCatgId;
    @ApiModelProperty(value = "物料类别站点主键，标识唯一物料类别站点分配数据，限定为采购站点", required = true)
    @NotBlank
    @Where
     ...
     */
    public String getPfepPurchaseSupplierCatgId() {
        return pfepPurchaseSupplierCatgId;
    }

    public void setPfepPurchaseSupplierCatgId(String pfepPurchaseSupplierCatgId) {
        this.pfepPurchaseSupplierCatgId = pfepPurchaseSupplierCatgId;
    }

    /**
     * @return 物料类别站点主键，标识唯一物料类别站点分配数据，限定为采购站点
     */
