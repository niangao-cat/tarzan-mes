...
@Table(name = "mt_pfep_schedule_category")
@CustomPrimary
public class MtPfepScheduleCategory extends AuditDomain {

    public static final String FIELD_TENANT_ID = "tenantId";
    public static final String FIELD_PFEP_SCHEDULE_CATEGORY_ID = "pfepScheduleCategoryId";
    ...
    @Id
    @Where
    private String pfepScheduleCategoryId;
    @ApiModelProperty(value = "物料类别站点主键，标识唯一物料类别站点分配数据，限定为计划站点", required = true)
    @NotBlank
    @Where
     ...
     */
    public String getPfepScheduleCategoryId() {
        return pfepScheduleCategoryId;
    }

    public void setPfepScheduleCategoryId(String pfepScheduleCategoryId) {
        this.pfepScheduleCategoryId = pfepScheduleCategoryId;
    }

    /**
     * @return 物料类别站点主键，标识唯一物料类别站点分配数据，限定为计划站点
     */
