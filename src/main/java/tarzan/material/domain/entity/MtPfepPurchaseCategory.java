...
@Table(name = "mt_pfep_purchase_category")
@CustomPrimary
public class MtPfepPurchaseCategory extends AuditDomain {

    public static final String FIELD_TENANT_ID = "tenantId";
    public static final String FIELD_PFEP_PURCHASE_CATEGORY_ID = "pfepPurchaseCategoryId";
    ...
    @Id
    @Where
    private String pfepPurchaseCategoryId;
     ...
     */
    public String getPfepPurchaseCategoryId() {
        return pfepPurchaseCategoryId;
    }

    public void setPfepPurchaseCategoryId(String pfepPurchaseCategoryId) {
        this.pfepPurchaseCategoryId = pfepPurchaseCategoryId;
    }
