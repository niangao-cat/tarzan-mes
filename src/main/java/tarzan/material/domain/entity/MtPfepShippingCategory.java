...
@Table(name = "mt_pfep_shipping_category")
@CustomPrimary
public class MtPfepShippingCategory extends AuditDomain {

    public static final String FIELD_TENANT_ID = "tenantId";
    public static final String FIELD_PFEP_SHIPPING_CATEGORY_ID = "pfepShippingCategoryId";
    ...
    @Id
    @Where
    private String pfepShippingCategoryId;
     ...
     */
    public String getPfepShippingCategoryId() {
        return pfepShippingCategoryId;
    }

    public void setPfepShippingCategoryId(String pfepShippingCategoryId) {
        this.pfepShippingCategoryId = pfepShippingCategoryId;
    }

    /**
     * @return 物料类别站点主键，标识唯一物料类别站点分配数据，限定为生产站点
     */
