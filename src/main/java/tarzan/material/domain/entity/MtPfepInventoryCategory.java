...
@Table(name = "mt_pfep_inventory_category")
@CustomPrimary
public class MtPfepInventoryCategory extends AuditDomain {

    public static final String FIELD_TENANT_ID = "tenantId";
    public static final String FIELD_PFEP_INVENTORY_CATEGORY_ID = "pfepInventoryCategoryId";
