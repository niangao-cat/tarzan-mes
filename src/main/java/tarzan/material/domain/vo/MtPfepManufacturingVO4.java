...
/**
 * @author peng.yuan
 * @ClassName MtPfepManufacturingVO4
 * @description
 * @date 2019年10月11日 18:55
 */
public class MtPfepManufacturingVO4 implements Serializable {
    private static final long serialVersionUID = -1815552321923475382L;
