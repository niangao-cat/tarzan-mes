...
@Table(name = "mt_bom_substitute_his")
@CustomPrimary
public class MtBomSubstituteHis extends AuditDomain {

    public static final String FIELD_TENANT_ID = "tenantId";
    public static final String FIELD_BOM_SUBSTITUTE_HIS_ID = "bomSubstituteHisId";
    ...
    @Id
    @Where
    private String bomSubstituteHisId;
    @ApiModelProperty(value = "装配清单行替代项ID", required = true)
    @NotBlank
    @Where
     ...
     * @return 唯一性索引
     */
    public String getBomSubstituteHisId() {
        return bomSubstituteHisId;
    }

    public void setBomSubstituteHisId(String bomSubstituteHisId) {
