 ...
 */
@ApiModel("工艺路线步骤对应工序组件历史")

@ModifyAudit
@JsonInclude(value = JsonInclude.Include.NON_NULL)
@Table(name = "mt_router_operation_comp_his")
@CustomPrimary
public class MtRouterOperationCompHis extends AuditDomain {

    public static final String FIELD_TENANT_ID = "tenantId";
    public static final String FIELD_ROUTER_OPERATION_COMP_HIS_ID = "routerOperationCompHisId";
    ...
    @ApiModelProperty("工艺路线步骤组件历史主键，唯一性标识")
    @Id
    @Where
    private String routerOperationCompHisId;
    @ApiModelProperty(value = "工艺路线步骤组件唯一标识", required = true)
    @NotBlank
    @Where
    ...
    /**
     * @return 工艺路线步骤组件历史主键，唯一性标识
     */
    public String getRouterOperationCompHisId() {
        return routerOperationCompHisId;
    }

    public void setRouterOperationCompHisId(String routerOperationCompHisId) {
        this.routerOperationCompHisId = routerOperationCompHisId;
    }
