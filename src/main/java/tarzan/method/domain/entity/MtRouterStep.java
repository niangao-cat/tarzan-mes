...
@MultiLanguage
@Table(name = "mt_router_step")
@CustomPrimary
public class MtRouterStep extends AuditDomain {
    ...
    @ApiModelProperty(value = "步骤类型：TYPE_GROUP:ROUTER_STEP_TYPE", required = true)
    @NotBlank
    @Where
    ...
    /**
     * @return 步骤类型：TYPE_GROUP:ROUTER_STEP_TYPE 1.【OPERATION】工艺 2.【GROUP】步骤组 3.【ROUTER】嵌套工艺路线
     */
