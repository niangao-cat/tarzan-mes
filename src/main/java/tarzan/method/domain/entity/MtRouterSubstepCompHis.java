...
@Table(name = "mt_router_substep_comp_his")
@CustomPrimary
public class MtRouterSubstepCompHis extends AuditDomain {

    public static final String FIELD_TENANT_ID = "tenantId";
    public static final String FIELD_ROUTER_SUBSTEP_COMP_HIS_ID = "routerSubstepCompHisId";
    ...
    @ApiModelProperty("工艺路线子步骤组件历史唯一标识")
    @Id
    @Where
    private String routerSubstepCompHisId;
    @ApiModelProperty(value = "工艺路线子步骤组件标识", required = true)
    @NotBlank
    @Where
    ...
    /**
     * @return 工艺路线子步骤组件历史唯一标识
     */
    public String getRouterSubstepCompHisId() {
        return routerSubstepCompHisId;
    }

    public void setRouterSubstepCompHisId(String routerSubstepCompHisId) {
        this.routerSubstepCompHisId = routerSubstepCompHisId;
    }
