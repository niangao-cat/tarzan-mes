...
@MultiLanguage
@Table(name = "mt_nc_code")
@CustomPrimary
public class MtNcCode extends AuditDomain {
    ...
    public static final String FIELD_NC_CODE = "ncCode";
    ...
    @ApiModelProperty(value = "站点为“生产类型”", required = true)
    @NotBlank
    @Where
    private String siteId;
    @ApiModelProperty(value = "不良代码编码，前台通常显示此值", required = true)
    @NotBlank
    @Where
    ...
    @ApiModelProperty(value = "值集已维护在表GEN_TYPE中，对应字段TYPE_GROUP为“NC”", required = true)
    @NotBlank
    @Where
    private String ncType;
    @ApiModelProperty(value = "是否可供车间使用（Y/N）", required = true)
    @NotBlank
    @Where
    ...
    /**
     * @return 值集已维护在表GEN_TYPE中，对应字段TYPE_GROUP为“NC”： 1.[FAILURE]缺陷 2.[DEFECT]瑕疵 3.[REPAIR]修复
     */
