...
@Table(name = "mt_router_next_step_his")
@CustomPrimary
public class MtRouterNextStepHis extends AuditDomain {

    public static final String FIELD_TENANT_ID = "tenantId";
    public static final String FIELD_ROUTER_NEXT_STEP_HIS_ID = "routerNextStepHisId";
    ...
    @Id
    @Where
    private String routerNextStepHisId;
     ...
     */
    public String getRouterNextStepHisId() {
        return routerNextStepHisId;
    }

    public void setRouterNextStepHisId(String routerNextStepHisId) {
        this.routerNextStepHisId = routerNextStepHisId;
    }
