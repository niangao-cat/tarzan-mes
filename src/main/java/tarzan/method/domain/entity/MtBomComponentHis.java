...
@Table(name = "mt_bom_component_his")
@CustomPrimary
public class MtBomComponentHis extends AuditDomain {

    public static final String FIELD_TENANT_ID = "tenantId";
    public static final String FIELD_BOM_COMPONENT_HIS_ID = "bomComponentHisId";
    ...
    @ApiModelProperty("物料清单行历史ID")
    @Id
    @Where
    private String bomComponentHisId;
    @ApiModelProperty(value = "物料清单行ID", required = true)
    @NotBlank
    @Where
     ...
     * @return 物料清单行历史ID
     */
    public String getBomComponentHisId() {
        return bomComponentHisId;
    }

    public void setBomComponentHisId(String bomComponentHisId) {
