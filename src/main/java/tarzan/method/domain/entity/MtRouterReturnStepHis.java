...
@Table(name = "mt_router_return_step_his")
@CustomPrimary
public class MtRouterReturnStepHis extends AuditDomain {

    public static final String FIELD_TENANT_ID = "tenantId";
    public static final String FIELD_ROUTER_RETURN_STEP_HIS_ID = "routerReturnStepHisId";
    ...
    @ApiModelProperty("返回步骤历史唯一性标识")
    @Id
    @Where
    private String routerReturnStepHisId;
    @ApiModelProperty(value = "返回步骤唯一标识", required = true)
    @NotBlank
    @Where
     ...
     * @return 返回步骤历史唯一性标识
     */
    public String getRouterReturnStepHisId() {
        return routerReturnStepHisId;
    }

    public void setRouterReturnStepHisId(String routerReturnStepHisId) {
        this.routerReturnStepHisId = routerReturnStepHisId;
    }
