 ...
 */
@ApiModel("装配清单行替代组历史表")

@ModifyAudit
@JsonInclude(value = JsonInclude.Include.NON_NULL)
@Table(name = "mt_bom_substitute_group_his")
@CustomPrimary
public class MtBomSubstituteGroupHis extends AuditDomain {

    public static final String FIELD_TENANT_ID = "tenantId";
    public static final String FIELD_BOM_SUBSTITUTE_GROUP_HIS_ID = "bomSubstituteGroupHisId";
    ...
    @Id
    @Where
    private String bomSubstituteGroupHisId;
    @ApiModelProperty(value = "装配清单行替代组ID", required = true)
    @NotBlank
    @Where
     ...
     * @return 唯一性索引
     */
    public String getBomSubstituteGroupHisId() {
        return bomSubstituteGroupHisId;
    }

    public void setBomSubstituteGroupHisId(String bomSubstituteGroupHisId) {
