 ...
 */
public class MtRouterStepVO11 implements Serializable {

	private static final long serialVersionUID = 763740045959715914L;
	...
	private String copyFromRouterStepId;
	...
	public String getCopyFromRouterStepId() {
		return copyFromRouterStepId;
	}

	public void setCopyFromRouterStepId(String copyFromRouterStepId) {
		this.copyFromRouterStepId =copyFromRouterStepId;
	}
