 ...
 */
@ApiModel("仓储物流指令内容历史表")

@ModifyAudit

@Table(name = "mt_instruction_his")
@CustomPrimary
public class MtInstructionHis extends AuditDomain implements Serializable {

    public static final String FIELD_TENANT_ID = "tenantId";
    public static final String FIELD_INSTRUCTION_HIS_ID = "instructionHisId";
    ...
    private static final long serialVersionUID = 6777245923960850795L;
