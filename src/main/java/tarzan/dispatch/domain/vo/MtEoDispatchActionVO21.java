 ...
 **/
public class MtEoDispatchActionVO21 implements Serializable {
    private static final long serialVersionUID = -9106180780485831483L;
    @ApiModelProperty("主键ID")
    private List<String> eoDispatchActionIdList;
    ...
    public List<String> getEoDispatchActionIdList() {
        return eoDispatchActionIdList;
    }

    public void setEoDispatchActionIdList(List<String> eoDispatchActionIdList) {
        this.eoDispatchActionIdList = eoDispatchActionIdList;
    }
