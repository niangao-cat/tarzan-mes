 ...
 * @Author: ${yiyang.xie}
 */
public class MtEoDispatchProcessVO10 implements Serializable {
    private static final long serialVersionUID = -8830113015005250820L;
    @ApiModelProperty("主键")
    private String eoDispatchProcessId;
    ...
    @ApiModelProperty(value = "本次分配数量（分到不同的WKC）")
