...
@ApiModel("调度过程处理表")
@ModifyAudit
@Table(name = "mt_eo_dispatch_process")
@CustomPrimary
public class MtEoDispatchProcess extends AuditDomain {

    public static final String FIELD_TENANT_ID = "tenantId";
    public static final String FIELD_EO_DISPATCH_PROCESS_ID = "eoDispatchProcessId";
