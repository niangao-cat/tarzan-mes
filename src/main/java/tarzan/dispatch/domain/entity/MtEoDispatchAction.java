...
@ApiModel("调度结果执行表")
@ModifyAudit
@Table(name = "mt_eo_dispatch_action")
@CustomPrimary
public class MtEoDispatchAction extends AuditDomain {

    public static final String FIELD_TENANT_ID = "tenantId";
    public static final String FIELD_EO_DISPATCH_ACTION_ID = "eoDispatchActionId";
