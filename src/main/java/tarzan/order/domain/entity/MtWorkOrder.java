...
@Table(name = "mt_work_order")
@CustomPrimary
public class MtWorkOrder extends AuditDomain implements Serializable {
    ...
    private static final long serialVersionUID = 7216492427537158228L;
    ...
    @ApiModelProperty("生产指令ID, 主键，供其他表做外键")
    @Id
    @Where
