...
@Table(name = "mt_eo_his")
@CustomPrimary
public class MtEoHis extends AuditDomain implements Serializable {

    public static final String FIELD_TENANT_ID = "tenantId";
    public static final String FIELD_EO_HIS_ID = "eoHisId";
    ...
    private static final long serialVersionUID = 3681797528315255424L;
    ...
    @ApiModelProperty(value = "工单，EO对应生产指令", required = true)
    @NotBlank
    @Where
