...
/**
 * @author peng.yuan
 * @ClassName MtContainerVO34
 * @description
 * @date 2019年12月03日 18:51
 */
public class MtContainerVO34 implements Serializable {
    private static final long serialVersionUID = 1421105800201438361L;
