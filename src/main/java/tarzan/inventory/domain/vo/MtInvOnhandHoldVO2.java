...
public class MtInvOnhandHoldVO2 implements Serializable {

    private static final long serialVersionUID = 2169126920771077782L;

    private String siteId; // 站点ID
    private String materialId; // 物料ID
    private String locatorId; // 库位ID
    private String lotCode; // 批次CODE
    private Double holdQuantity; // 保留数量
