 ...
 * @Description:
 */
public class MtMaterialLotVO15 implements Serializable {

    private static final long serialVersionUID = 7807123025230155151L;
    @ApiModelProperty("{物料批ID,顺序}")
    List<MtMaterialLotVO16> mtMaterialLotSequenceList;
    ...
    public List<MtMaterialLotVO16> getMtMaterialLotSequenceList() {
        return mtMaterialLotSequenceList;
    }

    public void setMtMaterialLotSequenceList(List<MtMaterialLotVO16> mtMaterialLotSequenceList) {
        this.mtMaterialLotSequenceList = mtMaterialLotSequenceList;
    }
