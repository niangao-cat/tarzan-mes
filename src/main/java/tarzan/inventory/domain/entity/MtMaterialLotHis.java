...
@Table(name = "mt_material_lot_his")
@CustomPrimary
public class MtMaterialLotHis extends AuditDomain implements Serializable {
    ...
    public static final String FIELD_TRX_PRIMARY_QTY = "trxPrimaryQty";
    public static final String FIELD_TRX_SECONDARY_QTY = "trxSecondaryQty";
    ...
    private static final long serialVersionUID = 5892926933137901537L;
    ...
    @ApiModelProperty(value = "描述该物料批的有效状态：Y：是，表示物料批当前有效N：否，表示物料批当前已经无效", required = true)
    @NotBlank
    @Where
    private String enableFlag;
    @ApiModelProperty(
                    value = "物料批所标识实物的质量状态物料批所标识实物的质量状态：OK：合格，表示实物目前质量合格，允许正常生产使用或者发货NG：不合格，表示实物目前质量不合格，可能需要退货或返修重工PENDING：待定，表示实物目前质量待定，可能需要进行质量检验才能进行使用：",
                    required = true)
    @NotBlank
    @Where
    ...
    @ApiModelProperty(value = "描述物料批表示的实物所有权属于客户还是供应商，包括：")
    @Where
    ...
    @ApiModelProperty(value = "当物料批被保留时，指示物料批的保留对象类型，内容包括：")
    @Where
    ...
    @ApiModelProperty(value = "事务数量-主单位用量")
    @Where
    private Double trxPrimaryQty;
    @ApiModelProperty(value = "事务数量-辅助单位用量")
    @Where
    private Double trxSecondaryQty;
    ...
    /**
     * @return 描述该物料批的有效状态：Y：是，表示物料批当前有效N：否，表示物料批当前已经无效
     */
    ...
    /**
     * @return 物料批所标识实物的质量状态物料批所标识实物的质量状态：OK：合格，表示实物目前质量合格，允许正常生产使用或者发货NG：不合格，表示实物目前质量不合格，可能需要退货或返修重工PENDING：待定，表示实物目前质量待定，可能需要进行质量检验才能进行使用：
     */
    ...
    /**
     * @return 指示将物料装载到物料批的时间，在物料批装载时进行赋值
     */
     ...
     * @return 事务数量-主单位用量
     */
    public Double getTrxPrimaryQty() {
        return trxPrimaryQty;
    }

    public void setTrxPrimaryQty(Double trxPrimaryQty) {
        this.trxPrimaryQty = trxPrimaryQty;
    }

    /**
     * @return 事务数量-辅助单位用量
     */
    public Double getTrxSecondaryQty() {
        return trxSecondaryQty;
    }

    public void setTrxSecondaryQty(Double trxSecondaryQty) {
        this.trxSecondaryQty = trxSecondaryQty;
    }
