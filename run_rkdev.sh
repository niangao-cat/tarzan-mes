...
# 启动项目
cd /home/mes/hcms/
nohup java -jar -Dspring.profiles.active=rkdev \
-Dspring.cloud.config.enabled=false \
-Dspring.cloud.config.uri=http://mesdev.raycus.com:8010 \
-Deureka.client.serviceUrl.defaultZone=http://mesdev.raycus.com:8000/eureka \
-Xms512m -Xmx1024m \
